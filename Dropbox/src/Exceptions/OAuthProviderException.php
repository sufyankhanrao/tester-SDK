 ...
 */
class OAuthProviderException extends \DropboxLib\Exceptions\ApiException
{
    /**
     * @var string
     */
    ...
    /**
     * @param string $reason
     * @param \DropboxLib\Http\HttpRequest $request
     * @param \DropboxLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \DropboxLib\Http\HttpRequest $request,
        \DropboxLib\Http\HttpResponse $response,
        string $error
    ) {
