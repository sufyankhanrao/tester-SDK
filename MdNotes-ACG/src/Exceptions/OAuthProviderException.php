 ...
 */
class OAuthProviderException extends \MdNotesACGLib\Exceptions\ApiException
{
    /**
     * @var string
     */
    ...
    /**
     * @param string $reason
     * @param \MdNotesACGLib\Http\HttpRequest $request
     * @param \MdNotesACGLib\Http\HttpResponse $response
     * @param string $error
     */
    public function __construct(
        string $reason,
        \MdNotesACGLib\Http\HttpRequest $request,
        \MdNotesACGLib\Http\HttpResponse $response,
        string $error
    ) {
