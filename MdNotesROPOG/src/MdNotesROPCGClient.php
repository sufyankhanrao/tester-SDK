...
use MdNotesROPCGLib\Controllers;

/**
 * MdNotesROPCGLib client class
 */
class MdNotesROPCGClient implements ConfigurationInterface
{
    private $service;
    private $user;
    ...
    private $oAuthUsername = ConfigurationDefaults::O_AUTH_USERNAME;
    private $oAuthPassword = ConfigurationDefaults::O_AUTH_PASSWORD;
    private $oAuthToken = ConfigurationDefaults::O_AUTH_TOKEN;
    private $resourcePasswordAuthManager;
    ...
    public function __construct(array $configOptions = null)
    {
        ...
        if (isset($configOptions['oAuthUsername'])) {
            $this->oAuthUsername = $configOptions['oAuthUsername'];
        }
        if (isset($configOptions['oAuthPassword'])) {
            $this->oAuthPassword = $configOptions['oAuthPassword'];
        }
        ...
        $this->resourcePasswordAuthManager = new ResourcePasswordAuthManager(
            $this->oAuthUsername,
            $this->oAuthPassword,
            $this->oAuthToken,
            $this
        );
        $this->authManagers['global'] = $this->resourcePasswordAuthManager;
    }
    ...
    public function getConfiguration(): array
    {
        ...
        if (isset($this->oAuthUsername)) {
            $configMap['oAuthUsername'] = $this->oAuthUsername;
        }
        if (isset($this->oAuthPassword)) {
            $configMap['oAuthPassword'] = $this->oAuthPassword;
        }
    ...
    public function getResourcePasswordAuth(): ?ResourcePasswordAuth
    {
        return $this->resourcePasswordAuthManager;
    }
