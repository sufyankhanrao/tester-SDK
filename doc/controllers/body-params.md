...
```java
Map<String, Employee> models = new LinkedHashMap<>();

Employee models0 = new Employee();
models0.setAddress(null);
models0.setAge(null);
models0.setBirthday(LocalDate.parse(null));
models0.setBirthtime(LocalDateTime.parse(null, DateTimeFormatter.ISO_DATE_TIME));
models0.setName(null);
models0.setUid(null);
models0.setDepartment(null);
models0.setDependents(new LinkedList<>());

models0.setHiredAt(DateTimeHelper.fromRfc1123DateTime(null));
models0.setJoiningDay(null);
models0.setSalary(null);
models0.setWorkingDays(new LinkedList<>());
models0.setBoss(new Person());
models0.getBoss().setAddress(null);
models0.getBoss().setAge(null);
models0.getBoss().setBirthday(LocalDate.parse(null));
models0.getBoss().setBirthtime(LocalDateTime.parse(null, DateTimeFormatter.ISO_DATE_TIME));
models0.getBoss().setName(null);
models0.getBoss().setUid(null);
models.put("",models0);

Employee models1 = new Employee();
models1.setAddress(null);
models1.setAge(null);
models1.setBirthday(LocalDate.parse(null));
models1.setBirthtime(LocalDateTime.parse(null, DateTimeFormatter.ISO_DATE_TIME));
models1.setName(null);
models1.setUid(null);
models1.setDepartment(null);
models1.setDependents(new LinkedList<>());

models1.setHiredAt(DateTimeHelper.fromRfc1123DateTime(null));
models1.setJoiningDay(null);
models1.setSalary(null);
models1.setWorkingDays(new LinkedList<>());
models1.setBoss(new Person());
models1.getBoss().setAddress(null);
models1.getBoss().setAge(null);
models1.getBoss().setBirthday(LocalDate.parse(null));
models1.getBoss().setBirthtime(LocalDateTime.parse(null, DateTimeFormatter.ISO_DATE_TIME));
models1.getBoss().setName(null);
models1.getBoss().setUid(null);
models.put("",models1);
...
```java
AllOptionals body = new AllOptionals();
