...
|  --- | --- | --- | --- | --- | --- |
| `ResponseData` | [`ResponseData`](/doc/models/response-data.md) | Required | - | ResponseData getResponseData() | setResponseData(ResponseData responseData) |
| `ResponseDetails` | `String` | Required | - | String getResponseDetails() | setResponseDetails(String responseDetails) |
| `ResponseStatus` | `int` | Required | - | int getResponseStatus() | setResponseStatus(int responseStatus) |
