...
|  --- | --- | --- | --- | --- | --- |
| `FeedUrl` | `String` | Required | - | String getFeedUrl() | setFeedUrl(String feedUrl) |
...
| `Entries` | [`List<Entry>`](/doc/models/entry.md) | Required | - | List<Entry> getEntries() | setEntries(List<Entry> entries) |
