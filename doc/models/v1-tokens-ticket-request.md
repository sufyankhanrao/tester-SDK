...
| `Ticket` | `String` | Required | A valid ticket that was created to store the token.<br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36` | String getTicket() | setTicket(String ticket) |
