...
| `AuthCode` | `String` | Required | Required on force transactions. Ignored for all other actions.<br>**Constraints**: *Maximum Length*: `6` | String getAuthCode() | setAuthCode(String authCode) |
