...
|  --- | --- | --- | --- | --- | --- |
| `AdditionalAmounts` | [`List<AdditionalAmounts1>`](../../doc/models/additional-amounts-1.md) | Optional | Additional amounts | List<AdditionalAmounts1> getAdditionalAmounts() | setAdditionalAmounts(List<AdditionalAmounts1> additionalAmounts) |
...
| `TipAmount` | `double` | Required | Optional tip amount. Tip is not supported for lodging and ecommerce merchants.<br>**Constraints**: `<= 9999999999` | double getTipAmount() | setTipAmount(double tipAmount) |
