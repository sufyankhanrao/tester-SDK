...
/**
 * This is a model class for AllSelfMailers type.
 */
public class AllSelfMailers {
     ...
     * @param  data  List of SelfMailer value for data.
     ...
     */
    protected AllSelfMailers(List<SelfMailer> data, String object, OptionalNullable<String> nextUrl,
     ...
     * @return Returns the List of SelfMailer
     */
    @JsonGetter("data")
     ...
     * Setter for Data.
     * list of self_mailers
     * @param data Value for List of SelfMailer
     */
    @JsonSetter("data")
    public void setData(List<SelfMailer> data) {
        this.data = data;
    }
    ...
    /**
     * Converts this AllSelfMailers into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AllSelfMailers [" + "data=" + data + ", object=" + object + ", nextUrl=" + nextUrl
                + ", previousUrl=" + previousUrl + ", count=" + count + "]";
    }

    /**
     * Builds a new {@link AllSelfMailers.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AllSelfMailers.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AllSelfMailers}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<SelfMailer> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link AllSelfMailers} object using the set fields.
         * @return {@link AllSelfMailers}
         */
        public AllSelfMailers build() {
            return new AllSelfMailers(data, object, nextUrl, previousUrl, count);
        }
    }
}
