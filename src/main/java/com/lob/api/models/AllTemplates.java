...
/**
 * This is a model class for AllTemplates type.
 */
public class AllTemplates {
     ...
     * @param  data  List of Template value for data.
     ...
     */
    protected AllTemplates(List<Template> data, String object, OptionalNullable<String> nextUrl,
     ...
     * Setter for Data.
     * list of templates
     * @param data Value for List of Template
     */
    @JsonSetter("data")
    ...
    /**
     * Converts this AllTemplates into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AllTemplates [" + "data=" + data + ", object=" + object + ", nextUrl=" + nextUrl
                + ", previousUrl=" + previousUrl + ", count=" + count + "]";
    }

    /**
     * Builds a new {@link AllTemplates.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AllTemplates.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AllTemplates}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder data(List<Template> data) {
            this.data = data;
            return this;
        }
        ...
        /**
         * Builds a new {@link AllTemplates} object using the set fields.
         * @return {@link AllTemplates}
         */
        public AllTemplates build() {
            return new AllTemplates(data, object, nextUrl, previousUrl, count);
        }
    }
}
