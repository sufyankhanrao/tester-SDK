...
/**
 * This is a model class for Editable type.
 */
public class Editable {
     ...
     */
    protected Editable(OptionalNullable<String> description, Metadata metadata,
    ...
    /**
     * Converts this Editable into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Editable [" + "description=" + description + ", metadata=" + metadata
                + ", mailType=" + mailType + ", mergeVariables=" + mergeVariables + ", sendDate="
                + sendDate + "]";
    }

    /**
     * Builds a new {@link Editable.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Editable.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Editable}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Editable} object using the set fields.
         * @return {@link Editable}
         */
        public Editable build() {
            return new Editable(description, metadata, mailType, mergeVariables, sendDate);
        }
    }
}
