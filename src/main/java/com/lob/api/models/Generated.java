...
/**
 * This is a model class for Generated type.
 */
public class Generated {
    ...
    /**
     * Converts this Generated into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Generated [" + "to=" + to + ", carrier=" + carrier + ", thumbnails=" + thumbnails
                + ", expectedDeliveryDate=" + expectedDeliveryDate + ", dateCreated=" + dateCreated
                + ", dateModified=" + dateModified + ", deleted=" + deleted + "]";
    }

    /**
     * Builds a new {@link Generated.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Generated.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(to, carrier)
    ...
    /**
     * Class to build instances of {@link Generated}.
     */
    public static class Builder {
         ...
         * @param  carrier  String value for carrier.
         */
        public Builder(Object to, String carrier) {
            this.to = to;
            this.carrier = carrier;
        }
        ...
        /**
         * Builds a new {@link Generated} object using the set fields.
         * @return {@link Generated}
         */
        public Generated build() {
            return new Generated(to, carrier, thumbnails, expectedDeliveryDate, dateCreated,
