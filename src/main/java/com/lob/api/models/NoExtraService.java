...
/**
 * This is a model class for NoExtraService type.
 */
public class NoExtraService {
     ...
     */
    protected NoExtraService(boolean color, Object to, String carrier, Object from, String id,
            List<TrackingEventNormal> trackingEvents, Object returnAddress,
    ...
    /**
     * Converts this NoExtraService into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "NoExtraService [" + "color=" + color + ", to=" + to + ", carrier=" + carrier
                + ", from=" + from + ", id=" + id + ", trackingEvents=" + trackingEvents
                ...
                + deleted + ", templateId=" + templateId + ", templateVersionId="
                + templateVersionId + ", object=" + object + "]";
    }

    /**
     * Builds a new {@link NoExtraService.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link NoExtraService.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(color, to, carrier, from, id)
    ...
    /**
     * Class to build instances of {@link NoExtraService}.
     */
    public static class Builder {
         ...
         * @param  id  String value for id.
         */
        public Builder(boolean color, Object to, String carrier, Object from, String id) {
            this.color = color;
            this.to = to;
            this.carrier = carrier;
            this.from = from;
        ...
        /**
         * Builds a new {@link NoExtraService} object using the set fields.
         * @return {@link NoExtraService}
         */
        public NoExtraService build() {
            return new NoExtraService(color, to, carrier, from, id, trackingEvents, returnAddress,
                    description, metadata, mergeVariables, sendDate, mailType, doubleSided,
                    addressPlacement, returnEnvelope, perforatedPage, customEnvelope, thumbnails,
                    expectedDeliveryDate, dateCreated, dateModified, deleted, templateId,
