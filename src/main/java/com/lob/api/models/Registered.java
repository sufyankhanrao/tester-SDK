...
public class Registered {
     ...
     * @param  trackingEvents  List of Object value for trackingEvents.
     * @param  returnAddress  Object value for returnAddress.
     ...
     */
    protected Registered(String extraService, boolean color, Object to, String carrier, Object from,
            String id, OptionalNullable<String> trackingNumber, List<Object> trackingEvents,
            Object returnAddress, OptionalNullable<String> description, Metadata metadata,
    ...
    public List<Object> getTrackingEvents() {
     ...
     * Tracking events are not populated for registered letters.
     * @param trackingEvents Value for List of Object
     */
    @JsonSetter("tracking_events")
    public void setTrackingEvents(List<Object> trackingEvents) {
        this.trackingEvents = trackingEvents;
    }
     ...
     * that is available if an account is signed up for the return envelope tracking beta, and has
     * `return_envelope`, and `perforated_page` fields populated in the API request.
     * @param returnAddress Value for Object
     */
    ...
    public String toString() {
        return "Registered [" + "extraService=" + extraService + ", color=" + color + ", to=" + to
                + ", carrier=" + carrier + ", from=" + from + ", id=" + id + ", trackingNumber="
                + trackingNumber + ", trackingEvents=" + trackingEvents + ", returnAddress="
                + returnAddress + ", description=" + description + ", metadata=" + metadata
                ...
                + perforatedPage + ", customEnvelope=" + customEnvelope + ", thumbnails="
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(extraService, color, to, carrier, from, id)
    ...
    public static class Builder {
         ...
         * @param  id  String value for id.
         */
        public Builder(String extraService, boolean color, Object to, String carrier, Object from,
                String id) {
            this.extraService = extraService;
            this.color = color;
            this.to = to;
         ...
         * @return Builder
         */
        public Builder trackingEvents(List<Object> trackingEvents) {
            this.trackingEvents = trackingEvents;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder returnAddress(Object returnAddress) {
            this.returnAddress = returnAddress;
            return this;
        }
        ...
        public Registered build() {
            return new Registered(extraService, color, to, carrier, from, id, trackingNumber,
                    trackingEvents, returnAddress, description, metadata, mergeVariables, sendDate,
                    mailType, doubleSided, addressPlacement, returnEnvelope, perforatedPage,
                    customEnvelope, thumbnails, expectedDeliveryDate, dateCreated, dateModified,
                    deleted, templateId, templateVersionId, object);
        }
    }
}
