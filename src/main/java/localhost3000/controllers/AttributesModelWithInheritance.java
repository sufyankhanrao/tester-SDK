...
import localhost3000.models.ModelWithInheritedAttributes;
import localhost3000.models.ServerResponse;

/**
 * This class lists all the endpoints of the groups.
 */
public final class AttributesModelWithInheritance extends BaseController {
     ...
     */
    public AttributesModelWithInheritance(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the ModelWithInheritedAttributes response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public ModelWithInheritedAttributes generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the ModelWithInheritedAttributes response from the API call
     */
    public CompletableFuture<ModelWithInheritedAttributes> generateAsync() {
     ...
     * @return An object of type ModelWithInheritedAttributes
     */
    private ModelWithInheritedAttributes handleGenerateResponse(
        ...
        ModelWithInheritedAttributes result = ApiHelper.deserializeXml(responseBody,
                ModelWithInheritedAttributes.class);
    ...
    public ServerResponse validate(
            final ModelWithInheritedAttributes body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final ModelWithInheritedAttributes body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "nest", ModelWithInheritedAttributes.class);
