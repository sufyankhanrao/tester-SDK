...
import localhost3000.models.BaseForDiscriminatorInAttribute;
import localhost3000.models.ServerResponse;

/**
 * This class lists all the endpoints of the groups.
 */
public final class DiscriminateUsingAttribute extends BaseController {
     ...
     */
    public DiscriminateUsingAttribute(Configuration config, HttpClient httpClient,
     ...
     * @return    Returns the BaseForDiscriminatorInAttribute response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public BaseForDiscriminatorInAttribute generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the BaseForDiscriminatorInAttribute response from the API call
     */
    public CompletableFuture<BaseForDiscriminatorInAttribute> generateAsync() {
     ...
     * @return An object of type BaseForDiscriminatorInAttribute
     */
    private BaseForDiscriminatorInAttribute handleGenerateResponse(
        ...
        BaseForDiscriminatorInAttribute result = ApiHelper.deserializeXml(responseBody,
                BaseForDiscriminatorInAttribute.class);
    ...
    public ServerResponse validate(
            final BaseForDiscriminatorInAttribute body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final BaseForDiscriminatorInAttribute body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "discriminated", BaseForDiscriminatorInAttribute.class);
