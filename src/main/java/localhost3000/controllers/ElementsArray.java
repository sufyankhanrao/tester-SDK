...
import localhost3000.models.SimpleArray;

/**
 * This class lists all the endpoints of the groups.
 */
public final class ElementsArray extends BaseController {
     ...
     */
    public ElementsArray(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the SimpleArray response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public SimpleArray generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the SimpleArray response from the API call
     */
    public CompletableFuture<SimpleArray> generateAsync() {
     ...
     * @return An object of type SimpleArray
     */
    private SimpleArray handleGenerateResponse(
        ...
        SimpleArray result = ApiHelper.deserializeXml(responseBody,
                SimpleArray.class);
    ...
    public ServerResponse validate(
            final SimpleArray body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final SimpleArray body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "useThis", SimpleArray.class);
