...
import localhost3000.models.ModelWithInheritedElements;
import localhost3000.models.ServerResponse;

/**
 * This class lists all the endpoints of the groups.
 */
public final class ElementsModelWithInheritance extends BaseController {
     ...
     */
    public ElementsModelWithInheritance(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the ModelWithInheritedElements response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public ModelWithInheritedElements generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the ModelWithInheritedElements response from the API call
     */
    public CompletableFuture<ModelWithInheritedElements> generateAsync() {
     ...
     * @return An object of type ModelWithInheritedElements
     */
    private ModelWithInheritedElements handleGenerateResponse(
        ...
        ModelWithInheritedElements result = ApiHelper.deserializeXml(responseBody,
                ModelWithInheritedElements.class);
    ...
    public ServerResponse validate(
            final ModelWithInheritedElements body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final ModelWithInheritedElements body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "ModelWithInheritedElements", ModelWithInheritedElements.class);
