...
public final class MixNonPrimitiveTypesInRequestBodyController extends BaseController {
    ...
    public ServerResponse sendAnyofContainerOfOneof(
            ...
            final SendAnyofContainerOfOneofSession session) throws ApiException, IOException {
    ...
    private HttpRequest buildSendAnyofContainerOfOneofRequest(
            ...
            final boolean isAtEndpointLevel,
            final boolean hasDiscriminator,
            final SendAnyofContainerOfOneofSession session) throws JsonProcessingException {
