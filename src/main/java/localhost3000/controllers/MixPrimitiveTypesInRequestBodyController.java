...
public final class MixPrimitiveTypesInRequestBodyController extends BaseController {
    ...
    public ServerResponse sendAnyofContainerOfOneof(
            ...
            final AnyOfContainerOfOneOf value) throws ApiException, IOException {
        HttpRequest request = buildSendAnyofContainerOfOneofRequest(isPrimitiveType,
                isAtEndpointLevel, hasDiscriminator, value);
    ...
    public CompletableFuture<ServerResponse> sendAnyofContainerOfOneofAsync(
        ...
        return makeHttpCallAsync(() -> buildSendAnyofContainerOfOneofRequest(isPrimitiveType,
                isAtEndpointLevel, hasDiscriminator, value),
    ...
    private HttpRequest buildSendAnyofContainerOfOneofRequest(
            ...
            final boolean isAtEndpointLevel,
            final boolean hasDiscriminator,
            final AnyOfContainerOfOneOf value) throws JsonProcessingException {
        ...
        String bodyJson = ApiHelper.serialize(value);
