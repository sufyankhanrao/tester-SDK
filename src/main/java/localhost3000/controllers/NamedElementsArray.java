...
import localhost3000.models.SimpleArrayWithElementName;

/**
 * This class lists all the endpoints of the groups.
 */
public final class NamedElementsArray extends BaseController {
     ...
     */
    public NamedElementsArray(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the SimpleArrayWithElementName response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public SimpleArrayWithElementName generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the SimpleArrayWithElementName response from the API call
     */
    public CompletableFuture<SimpleArrayWithElementName> generateAsync() {
     ...
     * @return An object of type SimpleArrayWithElementName
     */
    private SimpleArrayWithElementName handleGenerateResponse(
        ...
        SimpleArrayWithElementName result = ApiHelper.deserializeXml(responseBody,
                SimpleArrayWithElementName.class);
    ...
    public ServerResponse validate(
            final SimpleArrayWithElementName body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final SimpleArrayWithElementName body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "simpleArrayWithElementName", SimpleArrayWithElementName.class);
