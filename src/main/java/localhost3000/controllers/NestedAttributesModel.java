...
import localhost3000.models.ModelWithNestedAttributesModel;
import localhost3000.models.ServerResponse;

/**
 * This class lists all the endpoints of the groups.
 */
public final class NestedAttributesModel extends BaseController {
     ...
     */
    public NestedAttributesModel(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the ModelWithNestedAttributesModel response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public ModelWithNestedAttributesModel generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the ModelWithNestedAttributesModel response from the API call
     */
    public CompletableFuture<ModelWithNestedAttributesModel> generateAsync() {
     ...
     * @return An object of type ModelWithNestedAttributesModel
     */
    private ModelWithNestedAttributesModel handleGenerateResponse(
        ...
        ModelWithNestedAttributesModel result = ApiHelper.deserializeXml(responseBody,
                ModelWithNestedAttributesModel.class);
    ...
    public ServerResponse validate(
            final ModelWithNestedAttributesModel body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final ModelWithNestedAttributesModel body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "ModelWithNestedAttributesModel", ModelWithNestedAttributesModel.class);
