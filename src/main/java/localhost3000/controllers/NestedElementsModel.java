...
import localhost3000.models.ModelWithNestedElementsModel;
import localhost3000.models.ServerResponse;

/**
 * This class lists all the endpoints of the groups.
 */
public final class NestedElementsModel extends BaseController {
     ...
     */
    public NestedElementsModel(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the ModelWithNestedElementsModel response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public ModelWithNestedElementsModel generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the ModelWithNestedElementsModel response from the API call
     */
    public CompletableFuture<ModelWithNestedElementsModel> generateAsync() {
     ...
     * @return An object of type ModelWithNestedElementsModel
     */
    private ModelWithNestedElementsModel handleGenerateResponse(
        ...
        ModelWithNestedElementsModel result = ApiHelper.deserializeXml(responseBody,
                ModelWithNestedElementsModel.class);
    ...
    public ServerResponse validate(
            final ModelWithNestedElementsModel body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final ModelWithNestedElementsModel body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "response", ModelWithNestedElementsModel.class);
