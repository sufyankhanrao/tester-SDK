...
import localhost3000.models.SimpleAttributes;

/**
 * This class lists all the endpoints of the groups.
 */
public final class SimpleAttributesModel extends BaseController {
     ...
     */
    public SimpleAttributesModel(Configuration config, HttpClient httpClient,
    ...
    /**
     * This endpoint returns an XML document that should perfectly map onto the "Simple Attributes"
     * model.
     * @return    Returns the SimpleAttributes response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public SimpleAttributes generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the SimpleAttributes response from the API call
     */
    public CompletableFuture<SimpleAttributes> generateAsync() {
     ...
     * @return An object of type SimpleAttributes
     */
    private SimpleAttributes handleGenerateResponse(
        ...
        SimpleAttributes result = ApiHelper.deserializeXml(responseBody,
    ...
    public ServerResponse validate(
            final SimpleAttributes body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final SimpleAttributes body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "SimpleAttributes", SimpleAttributes.class);
