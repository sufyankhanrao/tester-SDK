...
import localhost3000.models.SimpleElements;

/**
 * This class lists all the endpoints of the groups.
 */
public final class SimpleElementsModel extends BaseController {
     ...
     */
    public SimpleElementsModel(Configuration config, HttpClient httpClient,
     ...
     * model.
     * @return    Returns the SimpleElements response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public SimpleElements generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the SimpleElements response from the API call
     */
    public CompletableFuture<SimpleElements> generateAsync() {
     ...
     * @return An object of type SimpleElements
     */
    private SimpleElements handleGenerateResponse(
        ...
        SimpleElements result = ApiHelper.deserializeXml(responseBody,
    ...
    public ServerResponse validate(
            final SimpleElements body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final SimpleElements body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "SimpleElements", SimpleElements.class);
