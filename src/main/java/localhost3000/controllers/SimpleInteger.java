 ...
 */
public final class SimpleInteger extends BaseController {
     ...
     */
    public SimpleInteger(Configuration config, HttpClient httpClient,
     ...
     */
    public Integer generate() throws ApiException, IOException, JAXBException {
     ...
     */
    private Integer handleGenerateResponse(
        ...
        int result = ApiHelper.deserializeXml(responseBody, Integer.class);
    ...
    public ServerResponse validate(
            final int body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final int body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "int", int.class);
