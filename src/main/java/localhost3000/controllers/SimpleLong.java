 ...
 */
public final class SimpleLong extends BaseController {
     ...
     */
    public SimpleLong(Configuration config, HttpClient httpClient,
     ...
     */
    public Long generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the Long response from the API call
     */
    public CompletableFuture<Long> generateAsync() {
     ...
     */
    private Long handleGenerateResponse(
        ...
        long result = ApiHelper.deserializeXml(responseBody, Long.class);
    ...
    public ServerResponse validate(
            final long body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final long body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "long", long.class);
