 ...
 */
public final class SimplePrecision extends BaseController {
     ...
     */
    public SimplePrecision(Configuration config, HttpClient httpClient,
     ...
     */
    public Double generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the Double response from the API call
     */
    public CompletableFuture<Double> generateAsync() {
     ...
     */
    private Double handleGenerateResponse(
        ...
        double result = ApiHelper.deserializeXml(responseBody, Double.class);
    ...
    public ServerResponse validate(
            final double body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final double body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "precision", double.class);
