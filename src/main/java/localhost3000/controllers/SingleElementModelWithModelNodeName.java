...
import localhost3000.models.SingleElementWithNodeName;

/**
 * This class lists all the endpoints of the groups.
 */
public final class SingleElementModelWithModelNodeName extends BaseController {
     ...
     */
    public SingleElementModelWithModelNodeName(Configuration config, HttpClient httpClient,
    ...
    /**
     * This endpoint returns an XML document that should perfectly map onto the "Simple Elements"
     * model.
     * @return    Returns the SingleElementWithNodeName response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public SingleElementWithNodeName generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the SingleElementWithNodeName response from the API call
     */
    public CompletableFuture<SingleElementWithNodeName> generateAsync() {
     ...
     * @return An object of type SingleElementWithNodeName
     */
    private SingleElementWithNodeName handleGenerateResponse(
        ...
        SingleElementWithNodeName result = ApiHelper.deserializeXml(responseBody,
                SingleElementWithNodeName.class);

        return result;
    }

    /**
     * This endpoint expects an XML document that should perfectly map onto the "Simple Attributes"
     * model.
    ...
    public ServerResponse validate(
            final SingleElementWithNodeName body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final SingleElementWithNodeName body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "someOtherName", SingleElementWithNodeName.class);
