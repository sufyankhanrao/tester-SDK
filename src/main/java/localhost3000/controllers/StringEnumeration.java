...
import localhost3000.models.StringEnum;

/**
 * This class lists all the endpoints of the groups.
 */
public final class StringEnumeration extends BaseController {
     ...
     */
    public StringEnumeration(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the StringEnum response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public StringEnum generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the StringEnum response from the API call
     */
    public CompletableFuture<StringEnum> generateAsync() {
     ...
     * @return An object of type StringEnum
     */
    private StringEnum handleGenerateResponse(
        ...
        String deserializedResponse = ApiHelper.deserializeXml(responseBody,
                String.class);
        StringEnum result = StringEnum.fromString(deserializedResponse);
    ...
    public ServerResponse validate(
            final StringEnum body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final StringEnum body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "stringEnum", StringEnum.class);
