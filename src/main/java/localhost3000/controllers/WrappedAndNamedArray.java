...
import localhost3000.models.WrappedArrayWithElementAndWrappingName;

/**
 * This class lists all the endpoints of the groups.
 */
public final class WrappedAndNamedArray extends BaseController {
     ...
     */
    public WrappedAndNamedArray(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the WrappedArrayWithElementAndWrappingName response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public WrappedArrayWithElementAndWrappingName generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the WrappedArrayWithElementAndWrappingName response from the API call
     */
    public CompletableFuture<WrappedArrayWithElementAndWrappingName> generateAsync() {
     ...
     * @return An object of type WrappedArrayWithElementAndWrappingName
     */
    private WrappedArrayWithElementAndWrappingName handleGenerateResponse(
        ...
        WrappedArrayWithElementAndWrappingName result = ApiHelper.deserializeXml(responseBody,
                WrappedArrayWithElementAndWrappingName.class);
    ...
    public ServerResponse validate(
            final WrappedArrayWithElementAndWrappingName body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final WrappedArrayWithElementAndWrappingName body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "wrappedArrayWithElementAndWrappingName", WrappedArrayWithElementAndWrappingName.class);
