...
import localhost3000.models.WrappedArrayWithElementName;

/**
 * This class lists all the endpoints of the groups.
 */
public final class WrappedArray extends BaseController {
     ...
     */
    public WrappedArray(Configuration config, HttpClient httpClient,
    ...
    /**
     * Generate.
     * @return    Returns the WrappedArrayWithElementName response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     * @throws    JAXBException    Signals that a JAXB exception occurred.
     */
    public WrappedArrayWithElementName generate() throws ApiException, IOException, JAXBException {
     ...
     * @return    Returns the WrappedArrayWithElementName response from the API call
     */
    public CompletableFuture<WrappedArrayWithElementName> generateAsync() {
     ...
     * @return An object of type WrappedArrayWithElementName
     */
    private WrappedArrayWithElementName handleGenerateResponse(
        ...
        WrappedArrayWithElementName result = ApiHelper.deserializeXml(responseBody,
                WrappedArrayWithElementName.class);
    ...
    public ServerResponse validate(
            final WrappedArrayWithElementName body) throws ApiException, IOException, JAXBException {
    ...
    private HttpRequest buildValidateRequest(
            final WrappedArrayWithElementName body) throws JsonProcessingException, JAXBException {
        //the base uri for api requests
        String baseUri = config.getBaseUri();
        ...
        //prepare and invoke the API call request to fetch the response
        String bodyXml = ApiHelper.serializeXml(body, "wrappedArrayWithElementName", WrappedArrayWithElementName.class);
