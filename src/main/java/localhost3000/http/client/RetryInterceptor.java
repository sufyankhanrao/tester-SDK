...
public class RetryInterceptor implements Interceptor {
    ...
    */
     ...
     * @param httpLogger for logging request and response.
     */
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        while (requestState != null && needToRetry(request, response)) {
            ...
            logResponse(requestState, response);
     ...
     * @param binaryResponse flag for expected response of request.
     */
    public void addRequestEntry(Request okHttpRequest, HttpRequest httpRequest,
            boolean binaryResponse) {
        this.requestEntries.put(okHttpRequest, new RequestState(httpRequest, binaryResponse));
    }
     ...
     */
    private void logResponse(RequestState requestState, Response response) {
        HttpResponse httpResponse = null;
        try {
            httpResponse = OkClient.convertResponse(requestState.httpRequest, response,
                    requestState.binaryResponse);
    ...
    private class RequestState {
        ...
        /**
         * To keep track of expected response against current request.
         */
        boolean binaryResponse;
        ...
        /**
         * Default Constructor.
         * @param httpRequest Internal HTTP request.
         * @param binaryResponse flag for expected response of request.
         */
        public RequestState(HttpRequest httpRequest, boolean binaryResponse) {
