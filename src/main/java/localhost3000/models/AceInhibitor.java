...
/**
 * This is a model class for AceInhibitor type.
 */
public class AceInhibitor
    ...
    /**
     * Converts this AceInhibitor into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "AceInhibitor [" + "name=" + name + ", strength=" + strength + ", dose=" + dose
                + ", route=" + route + ", sig=" + sig + ", pillCount=" + pillCount + ", refills="
                + refills + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link AceInhibitor.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link AceInhibitor.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link AceInhibitor}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link AceInhibitor} object using the set fields.
         * @return {@link AceInhibitor}
         */
        public AceInhibitor build() {
            return new AceInhibitor(name, strength, dose, route, sig, pillCount, refills);
        }
    }
}
