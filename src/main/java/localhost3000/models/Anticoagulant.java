...
/**
 * This is a model class for Anticoagulant type.
 */
public class Anticoagulant
    ...
    /**
     * Converts this Anticoagulant into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Anticoagulant [" + "name=" + name + ", strength=" + strength + ", dose=" + dose
                + ", route=" + route + ", sig=" + sig + ", pillCount=" + pillCount + ", refills="
                + refills + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link Anticoagulant.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Anticoagulant.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Anticoagulant}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Anticoagulant} object using the set fields.
         * @return {@link Anticoagulant}
         */
        public Anticoagulant build() {
            return new Anticoagulant(name, strength, dose, route, sig, pillCount, refills);
        }
    }
}
