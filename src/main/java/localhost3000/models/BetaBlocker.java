...
/**
 * This is a model class for BetaBlocker type.
 */
public class BetaBlocker
    ...
    /**
     * Converts this BetaBlocker into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BetaBlocker [" + "name=" + name + ", strength=" + strength + ", dose=" + dose
                + ", route=" + route + ", sig=" + sig + ", pillCount=" + pillCount + ", refills="
                + refills + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link BetaBlocker.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link BetaBlocker.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link BetaBlocker}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link BetaBlocker} object using the set fields.
         * @return {@link BetaBlocker}
         */
        public BetaBlocker build() {
            return new BetaBlocker(name, strength, dose, route, sig, pillCount, refills);
        }
    }
}
