...
/**
 * This is a model class for Diuretic type.
 */
public class Diuretic
    ...
    /**
     * Converts this Diuretic into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Diuretic [" + "name=" + name + ", strength=" + strength + ", dose=" + dose
                + ", route=" + route + ", sig=" + sig + ", pillCount=" + pillCount + ", refills="
                + refills + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link Diuretic.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Diuretic.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Diuretic}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Diuretic} object using the set fields.
         * @return {@link Diuretic}
         */
        public Diuretic build() {
            return new Diuretic(name, strength, dose, route, sig, pillCount, refills);
        }
    }
}
