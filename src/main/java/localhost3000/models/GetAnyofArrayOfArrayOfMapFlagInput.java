...
/**
 * This is a model class for GetAnyofArrayOfArrayOfMapFlagInput type.
 */
public class GetAnyofArrayOfArrayOfMapFlagInput {
     ...
     * Default constructor.
     */
    public GetAnyofArrayOfArrayOfMapFlagInput() {
    }
    ...
    /**
     * Converts this GetAnyofArrayOfArrayOfMapFlagInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetAnyofArrayOfArrayOfMapFlagInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetAnyofArrayOfArrayOfMapFlagInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetAnyofArrayOfArrayOfMapFlagInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetAnyofArrayOfArrayOfMapFlagInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetAnyofArrayOfArrayOfMapFlagInput} object using the set fields.
         * @return {@link GetAnyofArrayOfArrayOfMapFlagInput}
         */
        public GetAnyofArrayOfArrayOfMapFlagInput build() {
            return new GetAnyofArrayOfArrayOfMapFlagInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
