...
/**
 * This is a model class for GetAnyofInnerArrayInput type.
 */
public class GetAnyofInnerArrayInput {
     ...
     * Default constructor.
     */
    public GetAnyofInnerArrayInput() {
    }
    ...
    /**
     * Converts this GetAnyofInnerArrayInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetAnyofInnerArrayInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetAnyofInnerArrayInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetAnyofInnerArrayInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetAnyofInnerArrayInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetAnyofInnerArrayInput} object using the set fields.
         * @return {@link GetAnyofInnerArrayInput}
         */
        public GetAnyofInnerArrayInput build() {
            return new GetAnyofInnerArrayInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
