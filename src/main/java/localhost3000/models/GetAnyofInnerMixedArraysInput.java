...
/**
 * This is a model class for GetAnyofInnerMixedArraysInput type.
 */
public class GetAnyofInnerMixedArraysInput {
     ...
     * Default constructor.
     */
    public GetAnyofInnerMixedArraysInput() {
    }
    ...
    /**
     * Converts this GetAnyofInnerMixedArraysInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetAnyofInnerMixedArraysInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetAnyofInnerMixedArraysInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetAnyofInnerMixedArraysInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetAnyofInnerMixedArraysInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetAnyofInnerMixedArraysInput} object using the set fields.
         * @return {@link GetAnyofInnerMixedArraysInput}
         */
        public GetAnyofInnerMixedArraysInput build() {
            return new GetAnyofInnerMixedArraysInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
