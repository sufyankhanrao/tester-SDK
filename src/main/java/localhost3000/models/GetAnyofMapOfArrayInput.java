...
/**
 * This is a model class for GetAnyofMapOfArrayInput type.
 */
public class GetAnyofMapOfArrayInput {
     ...
     * Default constructor.
     */
    public GetAnyofMapOfArrayInput() {
    }
    ...
    /**
     * Converts this GetAnyofMapOfArrayInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetAnyofMapOfArrayInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetAnyofMapOfArrayInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetAnyofMapOfArrayInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetAnyofMapOfArrayInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetAnyofMapOfArrayInput} object using the set fields.
         * @return {@link GetAnyofMapOfArrayInput}
         */
        public GetAnyofMapOfArrayInput build() {
            return new GetAnyofMapOfArrayInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
