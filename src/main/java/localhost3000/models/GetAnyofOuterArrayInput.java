...
/**
 * This is a model class for GetAnyofOuterArrayInput type.
 */
public class GetAnyofOuterArrayInput {
     ...
     * Default constructor.
     */
    public GetAnyofOuterArrayInput() {
    }
    ...
    /**
     * Converts this GetAnyofOuterArrayInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetAnyofOuterArrayInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetAnyofOuterArrayInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetAnyofOuterArrayInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetAnyofOuterArrayInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetAnyofOuterArrayInput} object using the set fields.
         * @return {@link GetAnyofOuterArrayInput}
         */
        public GetAnyofOuterArrayInput build() {
            return new GetAnyofOuterArrayInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
