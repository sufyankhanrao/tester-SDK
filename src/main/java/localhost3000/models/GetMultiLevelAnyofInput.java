...
/**
 * This is a model class for GetMultiLevelAnyofInput type.
 */
public class GetMultiLevelAnyofInput {
     ...
     * Default constructor.
     */
    public GetMultiLevelAnyofInput() {
    }
    ...
    /**
     * Converts this GetMultiLevelAnyofInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "GetMultiLevelAnyofInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + "]";
    }

    /**
     * Builds a new {@link GetMultiLevelAnyofInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link GetMultiLevelAnyofInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link GetMultiLevelAnyofInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link GetMultiLevelAnyofInput} object using the set fields.
         * @return {@link GetMultiLevelAnyofInput}
         */
        public GetMultiLevelAnyofInput build() {
            return new GetMultiLevelAnyofInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator);
        }
    }
}
