...
/**
 * This is a model class for SendAnyofArrayOfMixedArraysInput type.
 */
public class SendAnyofArrayOfMixedArraysInput {
    private boolean isPrimitiveType;
    private boolean isAtEndpointLevel;
    private boolean hasDiscriminator;
    private ArrayOfMixedArrayCase arrayOfMixedArrayCase;

    /**
     * Default constructor.
     */
    public SendAnyofArrayOfMixedArraysInput() {
    }
     ...
     * @param  arrayOfMixedArrayCase  ArrayOfMixedArrayCase value for arrayOfMixedArrayCase.
     */
    public SendAnyofArrayOfMixedArraysInput(
            boolean isPrimitiveType,
            boolean isAtEndpointLevel,
            boolean hasDiscriminator,
            ArrayOfMixedArrayCase arrayOfMixedArrayCase) {
        this.isPrimitiveType = isPrimitiveType;
        this.isAtEndpointLevel = isAtEndpointLevel;
        this.hasDiscriminator = hasDiscriminator;
        this.arrayOfMixedArrayCase = arrayOfMixedArrayCase;
    }
    ...
    /**
     * Getter for ArrayOfMixedArrayCase.
     * @return Returns the ArrayOfMixedArrayCase
     */
    @JsonGetter("arrayOfMixedArrayCase")
    public ArrayOfMixedArrayCase getArrayOfMixedArrayCase() {
        return arrayOfMixedArrayCase;
    }

    /**
     * Setter for ArrayOfMixedArrayCase.
     * @param arrayOfMixedArrayCase Value for ArrayOfMixedArrayCase
     */
    @JsonSetter("arrayOfMixedArrayCase")
    public void setArrayOfMixedArrayCase(ArrayOfMixedArrayCase arrayOfMixedArrayCase) {
        this.arrayOfMixedArrayCase = arrayOfMixedArrayCase;
    }

    /**
     * Converts this SendAnyofArrayOfMixedArraysInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SendAnyofArrayOfMixedArraysInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + ", arrayOfMixedArrayCase=" + arrayOfMixedArrayCase + "]";
    }

    /**
     * Builds a new {@link SendAnyofArrayOfMixedArraysInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SendAnyofArrayOfMixedArraysInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SendAnyofArrayOfMixedArraysInput}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder arrayOfMixedArrayCase(ArrayOfMixedArrayCase arrayOfMixedArrayCase) {
            this.arrayOfMixedArrayCase = arrayOfMixedArrayCase;
            return this;
        }

        /**
         * Builds a new {@link SendAnyofArrayOfMixedArraysInput} object using the set fields.
         * @return {@link SendAnyofArrayOfMixedArraysInput}
         */
        public SendAnyofArrayOfMixedArraysInput build() {
            return new SendAnyofArrayOfMixedArraysInput(isPrimitiveType, isAtEndpointLevel,
                    hasDiscriminator, arrayOfMixedArrayCase);
        }
    }
}
