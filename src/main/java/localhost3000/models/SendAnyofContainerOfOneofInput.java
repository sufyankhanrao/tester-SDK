...
/**
 * This is a model class for SendAnyofContainerOfOneofInput type.
 */
public class SendAnyofContainerOfOneofInput {
    private boolean isPrimitiveType;
    private boolean isAtEndpointLevel;
    private boolean hasDiscriminator;
    private AnyOfContainerOfOneOf value;

    /**
     * Default constructor.
     */
    public SendAnyofContainerOfOneofInput() {
    }
     ...
     * @param  value  AnyOfContainerOfOneOf value for value.
     */
    public SendAnyofContainerOfOneofInput(
            boolean isPrimitiveType,
            boolean isAtEndpointLevel,
            boolean hasDiscriminator,
            AnyOfContainerOfOneOf value) {
    ...
    /**
     * Getter for Value.
     * @return Returns the AnyOfContainerOfOneOf
     */
    @JsonGetter("value")
    public AnyOfContainerOfOneOf getValue() {
        return value;
    }

    /**
     * Setter for Value.
     * @param value Value for AnyOfContainerOfOneOf
     */
    @JsonSetter("value")
    public void setValue(AnyOfContainerOfOneOf value) {
        this.value = value;
    }

    /**
     * Converts this SendAnyofContainerOfOneofInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SendAnyofContainerOfOneofInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + ", value=" + value + "]";
    }

    /**
     * Builds a new {@link SendAnyofContainerOfOneofInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SendAnyofContainerOfOneofInput.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(isPrimitiveType, isAtEndpointLevel, hasDiscriminator, value);
        return builder;
    }

    /**
     * Class to build instances of {@link SendAnyofContainerOfOneofInput}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder value(AnyOfContainerOfOneOf value) {
            this.value = value;
            return this;
        }

        /**
         * Builds a new {@link SendAnyofContainerOfOneofInput} object using the set fields.
         * @return {@link SendAnyofContainerOfOneofInput}
         */
        public SendAnyofContainerOfOneofInput build() {
            return new SendAnyofContainerOfOneofInput(isPrimitiveType, isAtEndpointLevel,
