...
/**
 * This is a model class for SendAnyofInnerMapInput type.
 */
public class SendAnyofInnerMapInput {
    private boolean isPrimitiveType;
    private boolean isAtEndpointLevel;
    private boolean hasDiscriminator;
    private InnerMapCase innerMapCase;

    /**
     * Default constructor.
     */
    public SendAnyofInnerMapInput() {
    }
    ...
    /**
     * Getter for InnerMapCase.
     * @return Returns the InnerMapCase
     */
    @JsonGetter("innerMapCase")
    public InnerMapCase getInnerMapCase() {
        return innerMapCase;
    }

    /**
     * Setter for InnerMapCase.
     * @param innerMapCase Value for InnerMapCase
     */
    @JsonSetter("innerMapCase")
    public void setInnerMapCase(InnerMapCase innerMapCase) {
        this.innerMapCase = innerMapCase;
    }

    /**
     * Converts this SendAnyofInnerMapInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SendAnyofInnerMapInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + ", innerMapCase=" + innerMapCase + "]";
    }

    /**
     * Builds a new {@link SendAnyofInnerMapInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SendAnyofInnerMapInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SendAnyofInnerMapInput}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder innerMapCase(InnerMapCase innerMapCase) {
            this.innerMapCase = innerMapCase;
            return this;
        }

        /**
         * Builds a new {@link SendAnyofInnerMapInput} object using the set fields.
         * @return {@link SendAnyofInnerMapInput}
         */
        public SendAnyofInnerMapInput build() {
            return new SendAnyofInnerMapInput(isPrimitiveType, isAtEndpointLevel, hasDiscriminator,
                    innerMapCase);
        }
    }
}
