...
/**
 * This is a model class for SendAnyofMapOfMapInput type.
 */
public class SendAnyofMapOfMapInput {
    private boolean isPrimitiveType;
    private boolean isAtEndpointLevel;
    private boolean hasDiscriminator;
    private MapOfMapsCase mapOfMapsCase;

    /**
     * Default constructor.
     */
    public SendAnyofMapOfMapInput() {
    }
    ...
    /**
     * Getter for MapOfMapsCase.
     * @return Returns the MapOfMapsCase
     */
    @JsonGetter("mapOfMapsCase")
    public MapOfMapsCase getMapOfMapsCase() {
        return mapOfMapsCase;
    }

    /**
     * Setter for MapOfMapsCase.
     * @param mapOfMapsCase Value for MapOfMapsCase
     */
    @JsonSetter("mapOfMapsCase")
    public void setMapOfMapsCase(MapOfMapsCase mapOfMapsCase) {
        this.mapOfMapsCase = mapOfMapsCase;
    }

    /**
     * Converts this SendAnyofMapOfMapInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SendAnyofMapOfMapInput [" + "isPrimitiveType=" + isPrimitiveType
                + ", isAtEndpointLevel=" + isAtEndpointLevel + ", hasDiscriminator="
                + hasDiscriminator + ", mapOfMapsCase=" + mapOfMapsCase + "]";
    }

    /**
     * Builds a new {@link SendAnyofMapOfMapInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SendAnyofMapOfMapInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SendAnyofMapOfMapInput}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder mapOfMapsCase(MapOfMapsCase mapOfMapsCase) {
            this.mapOfMapsCase = mapOfMapsCase;
            return this;
        }

        /**
         * Builds a new {@link SendAnyofMapOfMapInput} object using the set fields.
         * @return {@link SendAnyofMapOfMapInput}
         */
        public SendAnyofMapOfMapInput build() {
            return new SendAnyofMapOfMapInput(isPrimitiveType, isAtEndpointLevel, hasDiscriminator,
                    mapOfMapsCase);
        }
    }
}
