 ...
 */
@JsonDeserialize(using = ArrayOfArraysCaseValue.ArrayOfArraysCaseValueDeserializer.class)
public abstract class ArrayOfArraysCaseValue {
     ...
     */
    public static ArrayOfArraysCaseValue fromPrecision(List<Double> precision) {
     ...
     */
    public static ArrayOfArraysCaseValue fromMBoolean(List<Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends ArrayOfArraysCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends ArrayOfArraysCaseValue {
    ...
    /**
     * This is a custom deserializer class for ArrayOfArraysCaseValue.
     */
    protected static class ArrayOfArraysCaseValueDeserializer
        extends JsonDeserializer<ArrayOfArraysCaseValue> {

        @Override
        public ArrayOfArraysCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
