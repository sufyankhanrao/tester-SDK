 ...
 */
@JsonDeserialize(using = ArrayOfMapFlagOfArrayCaseValue.ArrayOfMapFlagOfArrayCaseValueDeserializer.class)
public abstract class ArrayOfMapFlagOfArrayCaseValue {
     ...
     */
    public static ArrayOfMapFlagOfArrayCaseValue fromPrecision(List<Double> precision) {
     ...
     */
    public static ArrayOfMapFlagOfArrayCaseValue fromMBoolean(List<Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends ArrayOfMapFlagOfArrayCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends ArrayOfMapFlagOfArrayCaseValue {
    ...
    /**
     * This is a custom deserializer class for ArrayOfMapFlagOfArrayCaseValue.
     */
    protected static class ArrayOfMapFlagOfArrayCaseValueDeserializer
        extends JsonDeserializer<ArrayOfMapFlagOfArrayCaseValue> {

        @Override
        public ArrayOfMapFlagOfArrayCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
