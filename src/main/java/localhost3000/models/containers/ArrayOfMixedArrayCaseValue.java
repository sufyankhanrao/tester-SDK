 ...
 */
@JsonDeserialize(using = ArrayOfMixedArrayCaseValue.ArrayOfMixedArrayCaseValueDeserializer.class)
public abstract class ArrayOfMixedArrayCaseValue {
     ...
     */
    public static ArrayOfMixedArrayCaseValue fromPrecision(double precision) {
     ...
     */
    public static ArrayOfMixedArrayCaseValue fromMBoolean(List<Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends ArrayOfMixedArrayCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends ArrayOfMixedArrayCaseValue {
    ...
    /**
     * This is a custom deserializer class for ArrayOfMixedArrayCaseValue.
     */
    protected static class ArrayOfMixedArrayCaseValueDeserializer
        extends JsonDeserializer<ArrayOfMixedArrayCaseValue> {

        @Override
        public ArrayOfMixedArrayCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
