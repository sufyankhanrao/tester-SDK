 ...
 */
@JsonDeserialize(using = GetAnyofArrayOfArraysSession.GetAnyofArrayOfArraysSessionDeserializer.class)
public abstract class GetAnyofArrayOfArraysSession {
     ...
     */
    public static GetAnyofArrayOfArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetAnyofArrayOfArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofArrayOfArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofArrayOfArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofArrayOfArraysSession.
     */
    protected static class GetAnyofArrayOfArraysSessionDeserializer
        extends JsonDeserializer<GetAnyofArrayOfArraysSession> {

        @Override
        public GetAnyofArrayOfArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
