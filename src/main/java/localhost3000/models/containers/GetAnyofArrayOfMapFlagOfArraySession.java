 ...
 */
@JsonDeserialize(using = GetAnyofArrayOfMapFlagOfArraySession.GetAnyofArrayOfMapFlagOfArraySessionDeserializer.class)
public abstract class GetAnyofArrayOfMapFlagOfArraySession {
     ...
     */
    public static GetAnyofArrayOfMapFlagOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetAnyofArrayOfMapFlagOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofArrayOfMapFlagOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofArrayOfMapFlagOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofArrayOfMapFlagOfArraySession.
     */
    protected static class GetAnyofArrayOfMapFlagOfArraySessionDeserializer
        extends JsonDeserializer<GetAnyofArrayOfMapFlagOfArraySession> {

        @Override
        public GetAnyofArrayOfMapFlagOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
