 ...
 */
@JsonDeserialize(using = GetAnyofArrayOfMapFlagOfMapSession.GetAnyofArrayOfMapFlagOfMapSessionDeserializer.class)
public abstract class GetAnyofArrayOfMapFlagOfMapSession {
     ...
     */
    public static GetAnyofArrayOfMapFlagOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetAnyofArrayOfMapFlagOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofArrayOfMapFlagOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofArrayOfMapFlagOfMapSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofArrayOfMapFlagOfMapSession.
     */
    protected static class GetAnyofArrayOfMapFlagOfMapSessionDeserializer
        extends JsonDeserializer<GetAnyofArrayOfMapFlagOfMapSession> {

        @Override
        public GetAnyofArrayOfMapFlagOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
