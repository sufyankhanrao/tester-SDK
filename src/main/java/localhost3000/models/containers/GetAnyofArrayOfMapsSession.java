 ...
 */
@JsonDeserialize(using = GetAnyofArrayOfMapsSession.GetAnyofArrayOfMapsSessionDeserializer.class)
public abstract class GetAnyofArrayOfMapsSession {
     ...
     */
    public static GetAnyofArrayOfMapsSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetAnyofArrayOfMapsSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofArrayOfMapsSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofArrayOfMapsSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofArrayOfMapsSession.
     */
    protected static class GetAnyofArrayOfMapsSessionDeserializer
        extends JsonDeserializer<GetAnyofArrayOfMapsSession> {

        @Override
        public GetAnyofArrayOfMapsSession deserialize(JsonParser jp, DeserializationContext ctxt)
