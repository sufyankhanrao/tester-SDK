 ...
 */
@JsonDeserialize(using = GetAnyofArrayOfMixedArraysSession.GetAnyofArrayOfMixedArraysSessionDeserializer.class)
public abstract class GetAnyofArrayOfMixedArraysSession {
     ...
     */
    public static GetAnyofArrayOfMixedArraysSession fromMorning(Morning morning) {
     ...
     */
    public static GetAnyofArrayOfMixedArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofArrayOfMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofArrayOfMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofArrayOfMixedArraysSession.
     */
    protected static class GetAnyofArrayOfMixedArraysSessionDeserializer
        extends JsonDeserializer<GetAnyofArrayOfMixedArraysSession> {

        @Override
        public GetAnyofArrayOfMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
