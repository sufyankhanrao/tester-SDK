 ...
 */
@JsonDeserialize(using = GetAnyofInnerArraySession.GetAnyofInnerArraySessionDeserializer.class)
public abstract class GetAnyofInnerArraySession {
     ...
     */
    public static GetAnyofInnerArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetAnyofInnerArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofInnerArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofInnerArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofInnerArraySession.
     */
    protected static class GetAnyofInnerArraySessionDeserializer
        extends JsonDeserializer<GetAnyofInnerArraySession> {

        @Override
        public GetAnyofInnerArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
