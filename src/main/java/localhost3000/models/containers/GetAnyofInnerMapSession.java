 ...
 */
@JsonDeserialize(using = GetAnyofInnerMapSession.GetAnyofInnerMapSessionDeserializer.class)
public abstract class GetAnyofInnerMapSession {
     ...
     */
    public static GetAnyofInnerMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetAnyofInnerMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofInnerMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofInnerMapSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofInnerMapSession.
     */
    protected static class GetAnyofInnerMapSessionDeserializer
        extends JsonDeserializer<GetAnyofInnerMapSession> {

        @Override
        public GetAnyofInnerMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
