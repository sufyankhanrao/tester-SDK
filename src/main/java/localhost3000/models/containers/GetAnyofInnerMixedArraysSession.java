 ...
 */
@JsonDeserialize(using = GetAnyofInnerMixedArraysSession.GetAnyofInnerMixedArraysSessionDeserializer.class)
public abstract class GetAnyofInnerMixedArraysSession {
     ...
     */
    public static GetAnyofInnerMixedArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetAnyofInnerMixedArraysSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofInnerMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofInnerMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofInnerMixedArraysSession.
     */
    protected static class GetAnyofInnerMixedArraysSessionDeserializer
        extends JsonDeserializer<GetAnyofInnerMixedArraysSession> {

        @Override
        public GetAnyofInnerMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
