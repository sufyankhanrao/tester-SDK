 ...
 */
@JsonDeserialize(using = GetAnyofInnerMixedMapOfArraySession.GetAnyofInnerMixedMapOfArraySessionDeserializer.class)
public abstract class GetAnyofInnerMixedMapOfArraySession {
     ...
     */
    public static GetAnyofInnerMixedMapOfArraySession fromMorning(
     ...
     */
    public static GetAnyofInnerMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofInnerMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofInnerMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofInnerMixedMapOfArraySession.
     */
    protected static class GetAnyofInnerMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<GetAnyofInnerMixedMapOfArraySession> {

        @Override
        public GetAnyofInnerMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
