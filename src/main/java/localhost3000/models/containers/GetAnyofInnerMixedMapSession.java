 ...
 */
@JsonDeserialize(using = GetAnyofInnerMixedMapSession.GetAnyofInnerMixedMapSessionDeserializer.class)
public abstract class GetAnyofInnerMixedMapSession {
     ...
     */
    public static GetAnyofInnerMixedMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetAnyofInnerMixedMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofInnerMixedMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofInnerMixedMapSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofInnerMixedMapSession.
     */
    protected static class GetAnyofInnerMixedMapSessionDeserializer
        extends JsonDeserializer<GetAnyofInnerMixedMapSession> {

        @Override
        public GetAnyofInnerMixedMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
