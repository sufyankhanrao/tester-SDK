 ...
 */
@JsonDeserialize(using = GetAnyofMapOfArrayOfMixedMapOfArraySession.GetAnyofMapOfArrayOfMixedMapOfArraySessionDeserializer.class)
public abstract class GetAnyofMapOfArrayOfMixedMapOfArraySession {
     ...
     */
    public static GetAnyofMapOfArrayOfMixedMapOfArraySession fromMorning(
     ...
     */
    public static GetAnyofMapOfArrayOfMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofMapOfArrayOfMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofMapOfArrayOfMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofMapOfArrayOfMixedMapOfArraySession.
     */
    protected static class GetAnyofMapOfArrayOfMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<GetAnyofMapOfArrayOfMixedMapOfArraySession> {

        @Override
        public GetAnyofMapOfArrayOfMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
