 ...
 */
@JsonDeserialize(using = GetAnyofMapOfArraySession.GetAnyofMapOfArraySessionDeserializer.class)
public abstract class GetAnyofMapOfArraySession {
     ...
     */
    public static GetAnyofMapOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetAnyofMapOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofMapOfArraySession.
     */
    protected static class GetAnyofMapOfArraySessionDeserializer
        extends JsonDeserializer<GetAnyofMapOfArraySession> {

        @Override
        public GetAnyofMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
