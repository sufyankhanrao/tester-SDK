 ...
 */
@JsonDeserialize(using = GetAnyofMapOfMapSession.GetAnyofMapOfMapSessionDeserializer.class)
public abstract class GetAnyofMapOfMapSession {
     ...
     */
    public static GetAnyofMapOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetAnyofMapOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetAnyofMapOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofMapOfMapSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofMapOfMapSession.
     */
    protected static class GetAnyofMapOfMapSessionDeserializer
        extends JsonDeserializer<GetAnyofMapOfMapSession> {

        @Override
        public GetAnyofMapOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
