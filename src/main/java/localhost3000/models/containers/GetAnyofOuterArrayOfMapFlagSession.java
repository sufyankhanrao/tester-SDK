 ...
 */
@JsonDeserialize(using = GetAnyofOuterArrayOfMapFlagSession.GetAnyofOuterArrayOfMapFlagSessionDeserializer.class)
public abstract class GetAnyofOuterArrayOfMapFlagSession {
     ...
     */
    public static GetAnyofOuterArrayOfMapFlagSession fromMorning(Morning morning) {
     ...
     */
    public static GetAnyofOuterArrayOfMapFlagSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofOuterArrayOfMapFlagSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofOuterArrayOfMapFlagSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofOuterArrayOfMapFlagSession.
     */
    protected static class GetAnyofOuterArrayOfMapFlagSessionDeserializer
        extends JsonDeserializer<GetAnyofOuterArrayOfMapFlagSession> {

        @Override
        public GetAnyofOuterArrayOfMapFlagSession deserialize(JsonParser jp, DeserializationContext ctxt)
