 ...
 */
@JsonDeserialize(using = GetAnyofOuterArraySession.GetAnyofOuterArraySessionDeserializer.class)
public abstract class GetAnyofOuterArraySession {
     ...
     */
    public static GetAnyofOuterArraySession fromMorning(Morning morning) {
     ...
     */
    public static GetAnyofOuterArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofOuterArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofOuterArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofOuterArraySession.
     */
    protected static class GetAnyofOuterArraySessionDeserializer
        extends JsonDeserializer<GetAnyofOuterArraySession> {

        @Override
        public GetAnyofOuterArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
