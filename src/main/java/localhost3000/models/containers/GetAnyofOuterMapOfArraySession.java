 ...
 */
@JsonDeserialize(using = GetAnyofOuterMapOfArraySession.GetAnyofOuterMapOfArraySessionDeserializer.class)
public abstract class GetAnyofOuterMapOfArraySession {
     ...
     */
    public static GetAnyofOuterMapOfArraySession fromMorning(Morning morning) {
     ...
     */
    public static GetAnyofOuterMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofOuterMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofOuterMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofOuterMapOfArraySession.
     */
    protected static class GetAnyofOuterMapOfArraySessionDeserializer
        extends JsonDeserializer<GetAnyofOuterMapOfArraySession> {

        @Override
        public GetAnyofOuterMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
