 ...
 */
@JsonDeserialize(using = GetAnyofSimpleSession.GetAnyofSimpleSessionDeserializer.class)
public abstract class GetAnyofSimpleSession {
     ...
     */
    public static GetAnyofSimpleSession fromMorning(Morning morning) {
     ...
     */
    public static GetAnyofSimpleSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetAnyofSimpleSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetAnyofSimpleSession {
    ...
    /**
     * This is a custom deserializer class for GetAnyofSimpleSession.
     */
    protected static class GetAnyofSimpleSessionDeserializer
        extends JsonDeserializer<GetAnyofSimpleSession> {

        @Override
        public GetAnyofSimpleSession deserialize(JsonParser jp, DeserializationContext ctxt)
