 ...
 */
@JsonDeserialize(using = GetMultiLevelAnyofSession.GetMultiLevelAnyofSessionDeserializer.class)
public abstract class GetMultiLevelAnyofSession {
     ...
     */
    public static GetMultiLevelAnyofSession fromMorning(Morning morning) {
        return new MorningCase(morning);
    }

    /**
     * Any-of type initialization method.
     * @param case1 GetMultiLevelAnyofSessionCase1 value for case1.
     * @return The Case1Case object.
     */
    public static GetMultiLevelAnyofSession fromCase1(GetMultiLevelAnyofSessionCase1 case1) {
    ...
    public interface Cases<R> {
        ...
        R case1(GetMultiLevelAnyofSessionCase1 case1);
    }
    ...
    private static class MorningCase extends GetMultiLevelAnyofSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class Case1 extends GetMultiLevelAnyofSession {

        @JsonValue
        private GetMultiLevelAnyofSessionCase1 case1;

        Case1(GetMultiLevelAnyofSessionCase1 case1) {
            this.case1 = case1;
        }
        ...
        private Case1(JsonNode jsonNode) throws IOException {
            this.case1 = ApiHelper.deserialize(jsonNode,
                GetMultiLevelAnyofSessionCase1.class);
        }
    ...
    /**
     * This is a custom deserializer class for GetMultiLevelAnyofSession.
     */
    protected static class GetMultiLevelAnyofSessionDeserializer
        extends JsonDeserializer<GetMultiLevelAnyofSession> {

        @Override
        public GetMultiLevelAnyofSession deserialize(JsonParser jp, DeserializationContext ctxt)
