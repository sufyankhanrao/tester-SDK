 ...
 */
@JsonDeserialize(using = GetMultiLevelAnyofSessionCase1.GetMultiLevelAnyofSessionCase1Deserializer.class)
public abstract class GetMultiLevelAnyofSessionCase1 {
     ...
     */
    public static GetMultiLevelAnyofSessionCase1 fromEvening(List<Evening> evening) {
     ...
     */
    public static GetMultiLevelAnyofSessionCase1 fromEvening2(Evening evening2) {
    ...
    private static class EveningCase extends GetMultiLevelAnyofSessionCase1 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class Evening2Case extends GetMultiLevelAnyofSessionCase1 {
    ...
    /**
     * This is a custom deserializer class for GetMultiLevelAnyofSessionCase1.
     */
    protected static class GetMultiLevelAnyofSessionCase1Deserializer
        extends JsonDeserializer<GetMultiLevelAnyofSessionCase1> {

        @Override
        public GetMultiLevelAnyofSessionCase1 deserialize(JsonParser jp, DeserializationContext ctxt)
