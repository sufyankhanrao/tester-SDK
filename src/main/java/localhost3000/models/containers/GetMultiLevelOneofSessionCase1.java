 ...
 */
@JsonDeserialize(using = GetMultiLevelOneofSessionCase1.GetMultiLevelOneofSessionCase1Deserializer.class)
public abstract class GetMultiLevelOneofSessionCase1 {
     ...
     */
    public static GetMultiLevelOneofSessionCase1 fromEvening(List<Evening> evening) {
     ...
     */
    public static GetMultiLevelOneofSessionCase1 fromEvening2(Evening evening2) {
    ...
    private static class EveningCase extends GetMultiLevelOneofSessionCase1 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class Evening2Case extends GetMultiLevelOneofSessionCase1 {
    ...
    /**
     * This is a custom deserializer class for GetMultiLevelOneofSessionCase1.
     */
    protected static class GetMultiLevelOneofSessionCase1Deserializer
        extends JsonDeserializer<GetMultiLevelOneofSessionCase1> {

        @Override
        public GetMultiLevelOneofSessionCase1 deserialize(JsonParser jp, DeserializationContext ctxt)
