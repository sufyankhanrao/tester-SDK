 ...
 */
@JsonDeserialize(using = GetOneofArrayOfArraysSession.GetOneofArrayOfArraysSessionDeserializer.class)
public abstract class GetOneofArrayOfArraysSession {
     ...
     */
    public static GetOneofArrayOfArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetOneofArrayOfArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetOneofArrayOfArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofArrayOfArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofArrayOfArraysSession.
     */
    protected static class GetOneofArrayOfArraysSessionDeserializer
        extends JsonDeserializer<GetOneofArrayOfArraysSession> {

        @Override
        public GetOneofArrayOfArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
