 ...
 */
@JsonDeserialize(using = GetOneofArrayOfMapsSession.GetOneofArrayOfMapsSessionDeserializer.class)
public abstract class GetOneofArrayOfMapsSession {
     ...
     */
    public static GetOneofArrayOfMapsSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetOneofArrayOfMapsSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetOneofArrayOfMapsSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofArrayOfMapsSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofArrayOfMapsSession.
     */
    protected static class GetOneofArrayOfMapsSessionDeserializer
        extends JsonDeserializer<GetOneofArrayOfMapsSession> {

        @Override
        public GetOneofArrayOfMapsSession deserialize(JsonParser jp, DeserializationContext ctxt)
