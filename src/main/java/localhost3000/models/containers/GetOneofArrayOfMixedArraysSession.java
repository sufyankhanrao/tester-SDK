 ...
 */
@JsonDeserialize(using = GetOneofArrayOfMixedArraysSession.GetOneofArrayOfMixedArraysSessionDeserializer.class)
public abstract class GetOneofArrayOfMixedArraysSession {
     ...
     */
    public static GetOneofArrayOfMixedArraysSession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofArrayOfMixedArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetOneofArrayOfMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofArrayOfMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofArrayOfMixedArraysSession.
     */
    protected static class GetOneofArrayOfMixedArraysSessionDeserializer
        extends JsonDeserializer<GetOneofArrayOfMixedArraysSession> {

        @Override
        public GetOneofArrayOfMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
