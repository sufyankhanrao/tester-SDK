 ...
 */
@JsonDeserialize(using = GetOneofInnerArraySession.GetOneofInnerArraySessionDeserializer.class)
public abstract class GetOneofInnerArraySession {
     ...
     */
    public static GetOneofInnerArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetOneofInnerArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetOneofInnerArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofInnerArraySession {
    ...
    /**
     * This is a custom deserializer class for GetOneofInnerArraySession.
     */
    protected static class GetOneofInnerArraySessionDeserializer
        extends JsonDeserializer<GetOneofInnerArraySession> {

        @Override
        public GetOneofInnerArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
