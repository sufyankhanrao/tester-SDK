 ...
 */
@JsonDeserialize(using = GetOneofInnerMapSession.GetOneofInnerMapSessionDeserializer.class)
public abstract class GetOneofInnerMapSession {
     ...
     */
    public static GetOneofInnerMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetOneofInnerMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetOneofInnerMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofInnerMapSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofInnerMapSession.
     */
    protected static class GetOneofInnerMapSessionDeserializer
        extends JsonDeserializer<GetOneofInnerMapSession> {

        @Override
        public GetOneofInnerMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
