 ...
 */
@JsonDeserialize(using = GetOneofInnerMixedArraysSession.GetOneofInnerMixedArraysSessionDeserializer.class)
public abstract class GetOneofInnerMixedArraysSession {
     ...
     */
    public static GetOneofInnerMixedArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetOneofInnerMixedArraysSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofInnerMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofInnerMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofInnerMixedArraysSession.
     */
    protected static class GetOneofInnerMixedArraysSessionDeserializer
        extends JsonDeserializer<GetOneofInnerMixedArraysSession> {

        @Override
        public GetOneofInnerMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
