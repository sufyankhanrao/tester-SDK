 ...
 */
@JsonDeserialize(using = GetOneofInnerMixedMapSession.GetOneofInnerMixedMapSessionDeserializer.class)
public abstract class GetOneofInnerMixedMapSession {
     ...
     */
    public static GetOneofInnerMixedMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetOneofInnerMixedMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofInnerMixedMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofInnerMixedMapSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofInnerMixedMapSession.
     */
    protected static class GetOneofInnerMixedMapSessionDeserializer
        extends JsonDeserializer<GetOneofInnerMixedMapSession> {

        @Override
        public GetOneofInnerMixedMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
