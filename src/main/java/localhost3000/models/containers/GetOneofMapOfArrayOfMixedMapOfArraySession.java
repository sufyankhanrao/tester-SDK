 ...
 */
@JsonDeserialize(using = GetOneofMapOfArrayOfMixedMapOfArraySession.GetOneofMapOfArrayOfMixedMapOfArraySessionDeserializer.class)
public abstract class GetOneofMapOfArrayOfMixedMapOfArraySession {
     ...
     */
    public static GetOneofMapOfArrayOfMixedMapOfArraySession fromMorning(
     ...
     */
    public static GetOneofMapOfArrayOfMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofMapOfArrayOfMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofMapOfArrayOfMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetOneofMapOfArrayOfMixedMapOfArraySession.
     */
    protected static class GetOneofMapOfArrayOfMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<GetOneofMapOfArrayOfMixedMapOfArraySession> {

        @Override
        public GetOneofMapOfArrayOfMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
