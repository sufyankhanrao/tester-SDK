 ...
 */
@JsonDeserialize(using = GetOneofMapOfArraySession.GetOneofMapOfArraySessionDeserializer.class)
public abstract class GetOneofMapOfArraySession {
     ...
     */
    public static GetOneofMapOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static GetOneofMapOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends GetOneofMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetOneofMapOfArraySession.
     */
    protected static class GetOneofMapOfArraySessionDeserializer
        extends JsonDeserializer<GetOneofMapOfArraySession> {

        @Override
        public GetOneofMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
