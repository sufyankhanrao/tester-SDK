 ...
 */
@JsonDeserialize(using = GetOneofMapOfInnerMixedMapSession.GetOneofMapOfInnerMixedMapSessionDeserializer.class)
public abstract class GetOneofMapOfInnerMixedMapSession {
     ...
     */
    public static GetOneofMapOfInnerMixedMapSession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofMapOfInnerMixedMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetOneofMapOfInnerMixedMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofMapOfInnerMixedMapSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofMapOfInnerMixedMapSession.
     */
    protected static class GetOneofMapOfInnerMixedMapSessionDeserializer
        extends JsonDeserializer<GetOneofMapOfInnerMixedMapSession> {

        @Override
        public GetOneofMapOfInnerMixedMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
