 ...
 */
@JsonDeserialize(using = GetOneofMapOfMapSession.GetOneofMapOfMapSessionDeserializer.class)
public abstract class GetOneofMapOfMapSession {
     ...
     */
    public static GetOneofMapOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static GetOneofMapOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends GetOneofMapOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofMapOfMapSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofMapOfMapSession.
     */
    protected static class GetOneofMapOfMapSessionDeserializer
        extends JsonDeserializer<GetOneofMapOfMapSession> {

        @Override
        public GetOneofMapOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
