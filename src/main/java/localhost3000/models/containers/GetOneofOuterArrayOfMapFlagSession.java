 ...
 */
@JsonDeserialize(using = GetOneofOuterArrayOfMapFlagSession.GetOneofOuterArrayOfMapFlagSessionDeserializer.class)
public abstract class GetOneofOuterArrayOfMapFlagSession {
     ...
     */
    public static GetOneofOuterArrayOfMapFlagSession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofOuterArrayOfMapFlagSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofOuterArrayOfMapFlagSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofOuterArrayOfMapFlagSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofOuterArrayOfMapFlagSession.
     */
    protected static class GetOneofOuterArrayOfMapFlagSessionDeserializer
        extends JsonDeserializer<GetOneofOuterArrayOfMapFlagSession> {

        @Override
        public GetOneofOuterArrayOfMapFlagSession deserialize(JsonParser jp, DeserializationContext ctxt)
