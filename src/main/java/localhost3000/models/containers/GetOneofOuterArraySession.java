 ...
 */
@JsonDeserialize(using = GetOneofOuterArraySession.GetOneofOuterArraySessionDeserializer.class)
public abstract class GetOneofOuterArraySession {
     ...
     */
    public static GetOneofOuterArraySession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofOuterArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofOuterArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofOuterArraySession {
    ...
    /**
     * This is a custom deserializer class for GetOneofOuterArraySession.
     */
    protected static class GetOneofOuterArraySessionDeserializer
        extends JsonDeserializer<GetOneofOuterArraySession> {

        @Override
        public GetOneofOuterArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
