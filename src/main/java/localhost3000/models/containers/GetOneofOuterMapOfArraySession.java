 ...
 */
@JsonDeserialize(using = GetOneofOuterMapOfArraySession.GetOneofOuterMapOfArraySessionDeserializer.class)
public abstract class GetOneofOuterMapOfArraySession {
     ...
     */
    public static GetOneofOuterMapOfArraySession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofOuterMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofOuterMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofOuterMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for GetOneofOuterMapOfArraySession.
     */
    protected static class GetOneofOuterMapOfArraySessionDeserializer
        extends JsonDeserializer<GetOneofOuterMapOfArraySession> {

        @Override
        public GetOneofOuterMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
