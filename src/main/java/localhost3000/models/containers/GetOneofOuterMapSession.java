 ...
 */
@JsonDeserialize(using = GetOneofOuterMapSession.GetOneofOuterMapSessionDeserializer.class)
public abstract class GetOneofOuterMapSession {
     ...
     */
    public static GetOneofOuterMapSession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofOuterMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofOuterMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofOuterMapSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofOuterMapSession.
     */
    protected static class GetOneofOuterMapSessionDeserializer
        extends JsonDeserializer<GetOneofOuterMapSession> {

        @Override
        public GetOneofOuterMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
