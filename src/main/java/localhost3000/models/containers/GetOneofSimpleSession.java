 ...
 */
@JsonDeserialize(using = GetOneofSimpleSession.GetOneofSimpleSessionDeserializer.class)
public abstract class GetOneofSimpleSession {
     ...
     */
    public static GetOneofSimpleSession fromMorning(Morning morning) {
     ...
     */
    public static GetOneofSimpleSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends GetOneofSimpleSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends GetOneofSimpleSession {
    ...
    /**
     * This is a custom deserializer class for GetOneofSimpleSession.
     */
    protected static class GetOneofSimpleSessionDeserializer
        extends JsonDeserializer<GetOneofSimpleSession> {

        @Override
        public GetOneofSimpleSession deserialize(JsonParser jp, DeserializationContext ctxt)
