 ...
 */
@JsonDeserialize(using = InnerArrayCaseValue.InnerArrayCaseValueDeserializer.class)
public abstract class InnerArrayCaseValue {
     ...
     */
    public static InnerArrayCaseValue fromPrecision(List<Double> precision) {
     ...
     */
    public static InnerArrayCaseValue fromMBoolean(List<Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends InnerArrayCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends InnerArrayCaseValue {
    ...
    /**
     * This is a custom deserializer class for InnerArrayCaseValue.
     */
    protected static class InnerArrayCaseValueDeserializer
        extends JsonDeserializer<InnerArrayCaseValue> {

        @Override
        public InnerArrayCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
