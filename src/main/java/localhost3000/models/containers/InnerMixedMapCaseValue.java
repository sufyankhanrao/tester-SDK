 ...
 */
@JsonDeserialize(using = InnerMixedMapCaseValue.InnerMixedMapCaseValueDeserializer.class)
public abstract class InnerMixedMapCaseValue {
     ...
     */
    public static InnerMixedMapCaseValue fromPrecision(Map<String, Double> precision) {
     ...
     */
    public static InnerMixedMapCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends InnerMixedMapCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends InnerMixedMapCaseValue {
    ...
    /**
     * This is a custom deserializer class for InnerMixedMapCaseValue.
     */
    protected static class InnerMixedMapCaseValueDeserializer
        extends JsonDeserializer<InnerMixedMapCaseValue> {

        @Override
        public InnerMixedMapCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
