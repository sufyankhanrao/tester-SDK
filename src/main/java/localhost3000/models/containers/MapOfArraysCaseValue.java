 ...
 */
@JsonDeserialize(using = MapOfArraysCaseValue.MapOfArraysCaseValueDeserializer.class)
public abstract class MapOfArraysCaseValue {
     ...
     */
    public static MapOfArraysCaseValue fromPrecision(List<Double> precision) {
     ...
     */
    public static MapOfArraysCaseValue fromMBoolean(List<Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends MapOfArraysCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends MapOfArraysCaseValue {
    ...
    /**
     * This is a custom deserializer class for MapOfArraysCaseValue.
     */
    protected static class MapOfArraysCaseValueDeserializer
        extends JsonDeserializer<MapOfArraysCaseValue> {

        @Override
        public MapOfArraysCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
