 ...
 */
@JsonDeserialize(using = MapOfMixedMapCaseValue.MapOfMixedMapCaseValueDeserializer.class)
public abstract class MapOfMixedMapCaseValue {
     ...
     */
    public static MapOfMixedMapCaseValue fromPrecision(double precision) {
     ...
     */
    public static MapOfMixedMapCaseValue fromMBoolean(Map<String, Boolean> mBoolean) {
    ...
    private static class PrecisionCase extends MapOfMixedMapCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends MapOfMixedMapCaseValue {
    ...
    /**
     * This is a custom deserializer class for MapOfMixedMapCaseValue.
     */
    protected static class MapOfMixedMapCaseValueDeserializer
        extends JsonDeserializer<MapOfMixedMapCaseValue> {

        @Override
        public MapOfMixedMapCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
