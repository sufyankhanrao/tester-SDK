 ...
 */
@JsonDeserialize(using = MixedArrayOfMapFlagCaseValue.MixedArrayOfMapFlagCaseValueDeserializer.class)
public abstract class MixedArrayOfMapFlagCaseValue {
     ...
     */
    public static MixedArrayOfMapFlagCaseValue fromPrecision(List<Map<String, Double>> precision) {
     ...
     */
    public static MixedArrayOfMapFlagCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends MixedArrayOfMapFlagCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends MixedArrayOfMapFlagCaseValue {
    ...
    /**
     * This is a custom deserializer class for MixedArrayOfMapFlagCaseValue.
     */
    protected static class MixedArrayOfMapFlagCaseValueDeserializer
        extends JsonDeserializer<MixedArrayOfMapFlagCaseValue> {

        @Override
        public MixedArrayOfMapFlagCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
