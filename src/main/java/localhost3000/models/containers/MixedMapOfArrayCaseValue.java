 ...
 */
@JsonDeserialize(using = MixedMapOfArrayCaseValue.MixedMapOfArrayCaseValueDeserializer.class)
public abstract class MixedMapOfArrayCaseValue {
     ...
     */
    public static MixedMapOfArrayCaseValue fromPrecision(Map<String, List<Double>> precision) {
     ...
     */
    public static MixedMapOfArrayCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends MixedMapOfArrayCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends MixedMapOfArrayCaseValue {
    ...
    /**
     * This is a custom deserializer class for MixedMapOfArrayCaseValue.
     */
    protected static class MixedMapOfArrayCaseValueDeserializer
        extends JsonDeserializer<MixedMapOfArrayCaseValue> {

        @Override
        public MixedMapOfArrayCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
