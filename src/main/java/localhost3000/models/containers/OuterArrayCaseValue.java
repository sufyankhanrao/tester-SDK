 ...
 */
@JsonDeserialize(using = OuterArrayCaseValue.OuterArrayCaseValueDeserializer.class)
public abstract class OuterArrayCaseValue {
     ...
     */
    public static OuterArrayCaseValue fromPrecision(double precision) {
     ...
     */
    public static OuterArrayCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends OuterArrayCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends OuterArrayCaseValue {
    ...
    /**
     * This is a custom deserializer class for OuterArrayCaseValue.
     */
    protected static class OuterArrayCaseValueDeserializer
        extends JsonDeserializer<OuterArrayCaseValue> {

        @Override
        public OuterArrayCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
