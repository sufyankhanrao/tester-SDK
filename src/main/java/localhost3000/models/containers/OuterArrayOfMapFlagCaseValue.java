 ...
 */
@JsonDeserialize(using = OuterArrayOfMapFlagCaseValue.OuterArrayOfMapFlagCaseValueDeserializer.class)
public abstract class OuterArrayOfMapFlagCaseValue {
     ...
     */
    public static OuterArrayOfMapFlagCaseValue fromPrecision(double precision) {
     ...
     */
    public static OuterArrayOfMapFlagCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends OuterArrayOfMapFlagCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends OuterArrayOfMapFlagCaseValue {
    ...
    /**
     * This is a custom deserializer class for OuterArrayOfMapFlagCaseValue.
     */
    protected static class OuterArrayOfMapFlagCaseValueDeserializer
        extends JsonDeserializer<OuterArrayOfMapFlagCaseValue> {

        @Override
        public OuterArrayOfMapFlagCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
