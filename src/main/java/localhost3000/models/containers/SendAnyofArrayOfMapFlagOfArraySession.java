 ...
 */
@JsonDeserialize(using = SendAnyofArrayOfMapFlagOfArraySession.SendAnyofArrayOfMapFlagOfArraySessionDeserializer.class)
public abstract class SendAnyofArrayOfMapFlagOfArraySession {
     ...
     */
    public static SendAnyofArrayOfMapFlagOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendAnyofArrayOfMapFlagOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofArrayOfMapFlagOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofArrayOfMapFlagOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofArrayOfMapFlagOfArraySession.
     */
    protected static class SendAnyofArrayOfMapFlagOfArraySessionDeserializer
        extends JsonDeserializer<SendAnyofArrayOfMapFlagOfArraySession> {

        @Override
        public SendAnyofArrayOfMapFlagOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
