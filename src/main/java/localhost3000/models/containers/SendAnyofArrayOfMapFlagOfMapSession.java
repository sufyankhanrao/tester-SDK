 ...
 */
@JsonDeserialize(using = SendAnyofArrayOfMapFlagOfMapSession.SendAnyofArrayOfMapFlagOfMapSessionDeserializer.class)
public abstract class SendAnyofArrayOfMapFlagOfMapSession {
     ...
     */
    public static SendAnyofArrayOfMapFlagOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendAnyofArrayOfMapFlagOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofArrayOfMapFlagOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofArrayOfMapFlagOfMapSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofArrayOfMapFlagOfMapSession.
     */
    protected static class SendAnyofArrayOfMapFlagOfMapSessionDeserializer
        extends JsonDeserializer<SendAnyofArrayOfMapFlagOfMapSession> {

        @Override
        public SendAnyofArrayOfMapFlagOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
