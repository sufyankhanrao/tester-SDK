 ...
 */
@JsonDeserialize(using = SendAnyofArrayOfMapsSession.SendAnyofArrayOfMapsSessionDeserializer.class)
public abstract class SendAnyofArrayOfMapsSession {
     ...
     */
    public static SendAnyofArrayOfMapsSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendAnyofArrayOfMapsSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofArrayOfMapsSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofArrayOfMapsSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofArrayOfMapsSession.
     */
    protected static class SendAnyofArrayOfMapsSessionDeserializer
        extends JsonDeserializer<SendAnyofArrayOfMapsSession> {

        @Override
        public SendAnyofArrayOfMapsSession deserialize(JsonParser jp, DeserializationContext ctxt)
