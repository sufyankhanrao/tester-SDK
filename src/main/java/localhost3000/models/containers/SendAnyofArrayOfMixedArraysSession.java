 ...
 */
@JsonDeserialize(using = SendAnyofArrayOfMixedArraysSession.SendAnyofArrayOfMixedArraysSessionDeserializer.class)
public abstract class SendAnyofArrayOfMixedArraysSession {
     ...
     */
    public static SendAnyofArrayOfMixedArraysSession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofArrayOfMixedArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofArrayOfMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofArrayOfMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofArrayOfMixedArraysSession.
     */
    protected static class SendAnyofArrayOfMixedArraysSessionDeserializer
        extends JsonDeserializer<SendAnyofArrayOfMixedArraysSession> {

        @Override
        public SendAnyofArrayOfMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
