 ...
 */
@JsonDeserialize(using = SendAnyofContainerOfOneofSessionCase1.SendAnyofContainerOfOneofSessionCase1Deserializer.class)
public abstract class SendAnyofContainerOfOneofSessionCase1 {
     ...
     */
    public static SendAnyofContainerOfOneofSessionCase1 fromEvening(Evening evening) {
     ...
     */
    public static SendAnyofContainerOfOneofSessionCase1 fromNoon(Noon noon) {
    ...
    private static class EveningCase extends SendAnyofContainerOfOneofSessionCase1 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class NoonCase extends SendAnyofContainerOfOneofSessionCase1 {
    ...
    /**
     * This is a custom deserializer class for SendAnyofContainerOfOneofSessionCase1.
     */
    protected static class SendAnyofContainerOfOneofSessionCase1Deserializer
        extends JsonDeserializer<SendAnyofContainerOfOneofSessionCase1> {

        @Override
        public SendAnyofContainerOfOneofSessionCase1 deserialize(JsonParser jp, DeserializationContext ctxt)
