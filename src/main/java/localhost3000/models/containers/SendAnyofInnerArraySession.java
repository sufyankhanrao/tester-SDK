 ...
 */
@JsonDeserialize(using = SendAnyofInnerArraySession.SendAnyofInnerArraySessionDeserializer.class)
public abstract class SendAnyofInnerArraySession {
     ...
     */
    public static SendAnyofInnerArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendAnyofInnerArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofInnerArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofInnerArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofInnerArraySession.
     */
    protected static class SendAnyofInnerArraySessionDeserializer
        extends JsonDeserializer<SendAnyofInnerArraySession> {

        @Override
        public SendAnyofInnerArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
