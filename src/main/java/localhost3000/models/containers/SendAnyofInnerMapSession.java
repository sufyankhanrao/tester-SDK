 ...
 */
@JsonDeserialize(using = SendAnyofInnerMapSession.SendAnyofInnerMapSessionDeserializer.class)
public abstract class SendAnyofInnerMapSession {
     ...
     */
    public static SendAnyofInnerMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendAnyofInnerMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofInnerMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofInnerMapSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofInnerMapSession.
     */
    protected static class SendAnyofInnerMapSessionDeserializer
        extends JsonDeserializer<SendAnyofInnerMapSession> {

        @Override
        public SendAnyofInnerMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
