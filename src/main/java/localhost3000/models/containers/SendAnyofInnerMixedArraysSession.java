 ...
 */
@JsonDeserialize(using = SendAnyofInnerMixedArraysSession.SendAnyofInnerMixedArraysSessionDeserializer.class)
public abstract class SendAnyofInnerMixedArraysSession {
     ...
     */
    public static SendAnyofInnerMixedArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendAnyofInnerMixedArraysSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofInnerMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofInnerMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofInnerMixedArraysSession.
     */
    protected static class SendAnyofInnerMixedArraysSessionDeserializer
        extends JsonDeserializer<SendAnyofInnerMixedArraysSession> {

        @Override
        public SendAnyofInnerMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
