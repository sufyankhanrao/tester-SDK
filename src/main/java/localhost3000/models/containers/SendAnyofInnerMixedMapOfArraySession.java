 ...
 */
@JsonDeserialize(using = SendAnyofInnerMixedMapOfArraySession.SendAnyofInnerMixedMapOfArraySessionDeserializer.class)
public abstract class SendAnyofInnerMixedMapOfArraySession {
     ...
     */
    public static SendAnyofInnerMixedMapOfArraySession fromMorning(
     ...
     */
    public static SendAnyofInnerMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofInnerMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofInnerMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofInnerMixedMapOfArraySession.
     */
    protected static class SendAnyofInnerMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<SendAnyofInnerMixedMapOfArraySession> {

        @Override
        public SendAnyofInnerMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
