 ...
 */
@JsonDeserialize(using = SendAnyofMapOfArrayOfMixedMapOfArraySession.SendAnyofMapOfArrayOfMixedMapOfArraySessionDeserializer.class)
public abstract class SendAnyofMapOfArrayOfMixedMapOfArraySession {
     ...
     */
    public static SendAnyofMapOfArrayOfMixedMapOfArraySession fromMorning(
     ...
     */
    public static SendAnyofMapOfArrayOfMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofMapOfArrayOfMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofMapOfArrayOfMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofMapOfArrayOfMixedMapOfArraySession.
     */
    protected static class SendAnyofMapOfArrayOfMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<SendAnyofMapOfArrayOfMixedMapOfArraySession> {

        @Override
        public SendAnyofMapOfArrayOfMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
