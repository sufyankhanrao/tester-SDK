 ...
 */
@JsonDeserialize(using = SendAnyofMapOfArraySession.SendAnyofMapOfArraySessionDeserializer.class)
public abstract class SendAnyofMapOfArraySession {
     ...
     */
    public static SendAnyofMapOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendAnyofMapOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofMapOfArraySession.
     */
    protected static class SendAnyofMapOfArraySessionDeserializer
        extends JsonDeserializer<SendAnyofMapOfArraySession> {

        @Override
        public SendAnyofMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
