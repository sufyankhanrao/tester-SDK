 ...
 */
@JsonDeserialize(using = SendAnyofMapOfMapSession.SendAnyofMapOfMapSessionDeserializer.class)
public abstract class SendAnyofMapOfMapSession {
     ...
     */
    public static SendAnyofMapOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendAnyofMapOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendAnyofMapOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofMapOfMapSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofMapOfMapSession.
     */
    protected static class SendAnyofMapOfMapSessionDeserializer
        extends JsonDeserializer<SendAnyofMapOfMapSession> {

        @Override
        public SendAnyofMapOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
