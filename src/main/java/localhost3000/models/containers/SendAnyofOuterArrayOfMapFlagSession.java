 ...
 */
@JsonDeserialize(using = SendAnyofOuterArrayOfMapFlagSession.SendAnyofOuterArrayOfMapFlagSessionDeserializer.class)
public abstract class SendAnyofOuterArrayOfMapFlagSession {
     ...
     */
    public static SendAnyofOuterArrayOfMapFlagSession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofOuterArrayOfMapFlagSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofOuterArrayOfMapFlagSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofOuterArrayOfMapFlagSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofOuterArrayOfMapFlagSession.
     */
    protected static class SendAnyofOuterArrayOfMapFlagSessionDeserializer
        extends JsonDeserializer<SendAnyofOuterArrayOfMapFlagSession> {

        @Override
        public SendAnyofOuterArrayOfMapFlagSession deserialize(JsonParser jp, DeserializationContext ctxt)
