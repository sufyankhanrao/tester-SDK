 ...
 */
@JsonDeserialize(using = SendAnyofOuterArraySession.SendAnyofOuterArraySessionDeserializer.class)
public abstract class SendAnyofOuterArraySession {
     ...
     */
    public static SendAnyofOuterArraySession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofOuterArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofOuterArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofOuterArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofOuterArraySession.
     */
    protected static class SendAnyofOuterArraySessionDeserializer
        extends JsonDeserializer<SendAnyofOuterArraySession> {

        @Override
        public SendAnyofOuterArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
