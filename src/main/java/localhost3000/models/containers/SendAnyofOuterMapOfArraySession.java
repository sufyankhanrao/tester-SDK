 ...
 */
@JsonDeserialize(using = SendAnyofOuterMapOfArraySession.SendAnyofOuterMapOfArraySessionDeserializer.class)
public abstract class SendAnyofOuterMapOfArraySession {
     ...
     */
    public static SendAnyofOuterMapOfArraySession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofOuterMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofOuterMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofOuterMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofOuterMapOfArraySession.
     */
    protected static class SendAnyofOuterMapOfArraySessionDeserializer
        extends JsonDeserializer<SendAnyofOuterMapOfArraySession> {

        @Override
        public SendAnyofOuterMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
