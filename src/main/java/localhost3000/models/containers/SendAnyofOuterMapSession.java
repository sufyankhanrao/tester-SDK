 ...
 */
@JsonDeserialize(using = SendAnyofOuterMapSession.SendAnyofOuterMapSessionDeserializer.class)
public abstract class SendAnyofOuterMapSession {
     ...
     */
    public static SendAnyofOuterMapSession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofOuterMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofOuterMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofOuterMapSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofOuterMapSession.
     */
    protected static class SendAnyofOuterMapSessionDeserializer
        extends JsonDeserializer<SendAnyofOuterMapSession> {

        @Override
        public SendAnyofOuterMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
