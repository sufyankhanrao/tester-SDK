 ...
 */
@JsonDeserialize(using = SendAnyofSimpleSession.SendAnyofSimpleSessionDeserializer.class)
public abstract class SendAnyofSimpleSession {
     ...
     */
    public static SendAnyofSimpleSession fromMorning(Morning morning) {
     ...
     */
    public static SendAnyofSimpleSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendAnyofSimpleSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendAnyofSimpleSession {
    ...
    /**
     * This is a custom deserializer class for SendAnyofSimpleSession.
     */
    protected static class SendAnyofSimpleSessionDeserializer
        extends JsonDeserializer<SendAnyofSimpleSession> {

        @Override
        public SendAnyofSimpleSession deserialize(JsonParser jp, DeserializationContext ctxt)
