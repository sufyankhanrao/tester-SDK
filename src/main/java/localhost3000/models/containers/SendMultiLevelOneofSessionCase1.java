 ...
 */
@JsonDeserialize(using = SendMultiLevelOneofSessionCase1.SendMultiLevelOneofSessionCase1Deserializer.class)
public abstract class SendMultiLevelOneofSessionCase1 {
     ...
     */
    public static SendMultiLevelOneofSessionCase1 fromEvening(List<Evening> evening) {
     ...
     */
    public static SendMultiLevelOneofSessionCase1 fromEvening2(Evening evening2) {
    ...
    private static class EveningCase extends SendMultiLevelOneofSessionCase1 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class Evening2Case extends SendMultiLevelOneofSessionCase1 {
    ...
    /**
     * This is a custom deserializer class for SendMultiLevelOneofSessionCase1.
     */
    protected static class SendMultiLevelOneofSessionCase1Deserializer
        extends JsonDeserializer<SendMultiLevelOneofSessionCase1> {

        @Override
        public SendMultiLevelOneofSessionCase1 deserialize(JsonParser jp, DeserializationContext ctxt)
                throws IOException, JsonProcessingException {
            ObjectCodec oc = jp.getCodec();
            JsonNode node = oc.readTree(jp);
            return ApiHelper.deserialize(node, Arrays.asList(EveningCase.class,
                    Evening2Case.class), true);
        }
    }
