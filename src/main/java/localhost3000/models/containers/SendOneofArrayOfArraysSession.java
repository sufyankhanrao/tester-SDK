 ...
 */
@JsonDeserialize(using = SendOneofArrayOfArraysSession.SendOneofArrayOfArraysSessionDeserializer.class)
public abstract class SendOneofArrayOfArraysSession {
     ...
     */
    public static SendOneofArrayOfArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendOneofArrayOfArraysSession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendOneofArrayOfArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofArrayOfArraysSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofArrayOfArraysSession.
     */
    protected static class SendOneofArrayOfArraysSessionDeserializer
        extends JsonDeserializer<SendOneofArrayOfArraysSession> {

        @Override
        public SendOneofArrayOfArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
