 ...
 */
@JsonDeserialize(using = SendOneofArrayOfMapFlagOfArraySession.SendOneofArrayOfMapFlagOfArraySessionDeserializer.class)
public abstract class SendOneofArrayOfMapFlagOfArraySession {
     ...
     */
    public static SendOneofArrayOfMapFlagOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendOneofArrayOfMapFlagOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendOneofArrayOfMapFlagOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofArrayOfMapFlagOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofArrayOfMapFlagOfArraySession.
     */
    protected static class SendOneofArrayOfMapFlagOfArraySessionDeserializer
        extends JsonDeserializer<SendOneofArrayOfMapFlagOfArraySession> {

        @Override
        public SendOneofArrayOfMapFlagOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
