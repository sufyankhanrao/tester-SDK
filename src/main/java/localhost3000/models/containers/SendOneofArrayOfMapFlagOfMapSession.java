 ...
 */
@JsonDeserialize(using = SendOneofArrayOfMapFlagOfMapSession.SendOneofArrayOfMapFlagOfMapSessionDeserializer.class)
public abstract class SendOneofArrayOfMapFlagOfMapSession {
     ...
     */
    public static SendOneofArrayOfMapFlagOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendOneofArrayOfMapFlagOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendOneofArrayOfMapFlagOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofArrayOfMapFlagOfMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofArrayOfMapFlagOfMapSession.
     */
    protected static class SendOneofArrayOfMapFlagOfMapSessionDeserializer
        extends JsonDeserializer<SendOneofArrayOfMapFlagOfMapSession> {

        @Override
        public SendOneofArrayOfMapFlagOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
