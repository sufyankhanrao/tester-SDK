 ...
 */
@JsonDeserialize(using = SendOneofArrayOfMapsSession.SendOneofArrayOfMapsSessionDeserializer.class)
public abstract class SendOneofArrayOfMapsSession {
     ...
     */
    public static SendOneofArrayOfMapsSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendOneofArrayOfMapsSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendOneofArrayOfMapsSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofArrayOfMapsSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofArrayOfMapsSession.
     */
    protected static class SendOneofArrayOfMapsSessionDeserializer
        extends JsonDeserializer<SendOneofArrayOfMapsSession> {

        @Override
        public SendOneofArrayOfMapsSession deserialize(JsonParser jp, DeserializationContext ctxt)
