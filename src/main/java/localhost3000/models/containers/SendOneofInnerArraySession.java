 ...
 */
@JsonDeserialize(using = SendOneofInnerArraySession.SendOneofInnerArraySessionDeserializer.class)
public abstract class SendOneofInnerArraySession {
     ...
     */
    public static SendOneofInnerArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendOneofInnerArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendOneofInnerArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofInnerArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofInnerArraySession.
     */
    protected static class SendOneofInnerArraySessionDeserializer
        extends JsonDeserializer<SendOneofInnerArraySession> {

        @Override
        public SendOneofInnerArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
