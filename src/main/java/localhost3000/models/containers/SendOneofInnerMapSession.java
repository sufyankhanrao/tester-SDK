 ...
 */
@JsonDeserialize(using = SendOneofInnerMapSession.SendOneofInnerMapSessionDeserializer.class)
public abstract class SendOneofInnerMapSession {
     ...
     */
    public static SendOneofInnerMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendOneofInnerMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendOneofInnerMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofInnerMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofInnerMapSession.
     */
    protected static class SendOneofInnerMapSessionDeserializer
        extends JsonDeserializer<SendOneofInnerMapSession> {

        @Override
        public SendOneofInnerMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
