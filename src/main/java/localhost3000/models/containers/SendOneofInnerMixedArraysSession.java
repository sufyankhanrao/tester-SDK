 ...
 */
@JsonDeserialize(using = SendOneofInnerMixedArraysSession.SendOneofInnerMixedArraysSessionDeserializer.class)
public abstract class SendOneofInnerMixedArraysSession {
     ...
     */
    public static SendOneofInnerMixedArraysSession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendOneofInnerMixedArraysSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofInnerMixedArraysSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofInnerMixedArraysSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofInnerMixedArraysSession.
     */
    protected static class SendOneofInnerMixedArraysSessionDeserializer
        extends JsonDeserializer<SendOneofInnerMixedArraysSession> {

        @Override
        public SendOneofInnerMixedArraysSession deserialize(JsonParser jp, DeserializationContext ctxt)
