 ...
 */
@JsonDeserialize(using = SendOneofInnerMixedMapOfArraySession.SendOneofInnerMixedMapOfArraySessionDeserializer.class)
public abstract class SendOneofInnerMixedMapOfArraySession {
     ...
     */
    public static SendOneofInnerMixedMapOfArraySession fromMorning(
     ...
     */
    public static SendOneofInnerMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofInnerMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofInnerMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofInnerMixedMapOfArraySession.
     */
    protected static class SendOneofInnerMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<SendOneofInnerMixedMapOfArraySession> {

        @Override
        public SendOneofInnerMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
