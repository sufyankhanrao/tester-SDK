 ...
 */
@JsonDeserialize(using = SendOneofInnerMixedMapSession.SendOneofInnerMixedMapSessionDeserializer.class)
public abstract class SendOneofInnerMixedMapSession {
     ...
     */
    public static SendOneofInnerMixedMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendOneofInnerMixedMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofInnerMixedMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofInnerMixedMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofInnerMixedMapSession.
     */
    protected static class SendOneofInnerMixedMapSessionDeserializer
        extends JsonDeserializer<SendOneofInnerMixedMapSession> {

        @Override
        public SendOneofInnerMixedMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
