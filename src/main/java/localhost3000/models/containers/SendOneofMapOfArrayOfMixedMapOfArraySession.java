 ...
 */
@JsonDeserialize(using = SendOneofMapOfArrayOfMixedMapOfArraySession.SendOneofMapOfArrayOfMixedMapOfArraySessionDeserializer.class)
public abstract class SendOneofMapOfArrayOfMixedMapOfArraySession {
     ...
     */
    public static SendOneofMapOfArrayOfMixedMapOfArraySession fromMorning(
     ...
     */
    public static SendOneofMapOfArrayOfMixedMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofMapOfArrayOfMixedMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofMapOfArrayOfMixedMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofMapOfArrayOfMixedMapOfArraySession.
     */
    protected static class SendOneofMapOfArrayOfMixedMapOfArraySessionDeserializer
        extends JsonDeserializer<SendOneofMapOfArrayOfMixedMapOfArraySession> {

        @Override
        public SendOneofMapOfArrayOfMixedMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
