 ...
 */
@JsonDeserialize(using = SendOneofMapOfArraySession.SendOneofMapOfArraySessionDeserializer.class)
public abstract class SendOneofMapOfArraySession {
     ...
     */
    public static SendOneofMapOfArraySession fromMorning(List<Morning> morning) {
     ...
     */
    public static SendOneofMapOfArraySession fromEvening(List<Evening> evening) {
    ...
    private static class MorningCase extends SendOneofMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofMapOfArraySession.
     */
    protected static class SendOneofMapOfArraySessionDeserializer
        extends JsonDeserializer<SendOneofMapOfArraySession> {

        @Override
        public SendOneofMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
