 ...
 */
@JsonDeserialize(using = SendOneofMapOfInnerMixedMapSession.SendOneofMapOfInnerMixedMapSessionDeserializer.class)
public abstract class SendOneofMapOfInnerMixedMapSession {
     ...
     */
    public static SendOneofMapOfInnerMixedMapSession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofMapOfInnerMixedMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendOneofMapOfInnerMixedMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofMapOfInnerMixedMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofMapOfInnerMixedMapSession.
     */
    protected static class SendOneofMapOfInnerMixedMapSessionDeserializer
        extends JsonDeserializer<SendOneofMapOfInnerMixedMapSession> {

        @Override
        public SendOneofMapOfInnerMixedMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
