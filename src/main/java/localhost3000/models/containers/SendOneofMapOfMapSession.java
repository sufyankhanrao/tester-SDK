 ...
 */
@JsonDeserialize(using = SendOneofMapOfMapSession.SendOneofMapOfMapSessionDeserializer.class)
public abstract class SendOneofMapOfMapSession {
     ...
     */
    public static SendOneofMapOfMapSession fromMorning(Map<String, Morning> morning) {
     ...
     */
    public static SendOneofMapOfMapSession fromEvening(Map<String, Evening> evening) {
    ...
    private static class MorningCase extends SendOneofMapOfMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofMapOfMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofMapOfMapSession.
     */
    protected static class SendOneofMapOfMapSessionDeserializer
        extends JsonDeserializer<SendOneofMapOfMapSession> {

        @Override
        public SendOneofMapOfMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
