 ...
 */
@JsonDeserialize(using = SendOneofOuterArrayOfMapFlagSession.SendOneofOuterArrayOfMapFlagSessionDeserializer.class)
public abstract class SendOneofOuterArrayOfMapFlagSession {
     ...
     */
    public static SendOneofOuterArrayOfMapFlagSession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofOuterArrayOfMapFlagSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofOuterArrayOfMapFlagSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofOuterArrayOfMapFlagSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofOuterArrayOfMapFlagSession.
     */
    protected static class SendOneofOuterArrayOfMapFlagSessionDeserializer
        extends JsonDeserializer<SendOneofOuterArrayOfMapFlagSession> {

        @Override
        public SendOneofOuterArrayOfMapFlagSession deserialize(JsonParser jp, DeserializationContext ctxt)
