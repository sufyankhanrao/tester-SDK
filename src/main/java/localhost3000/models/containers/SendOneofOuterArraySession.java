 ...
 */
@JsonDeserialize(using = SendOneofOuterArraySession.SendOneofOuterArraySessionDeserializer.class)
public abstract class SendOneofOuterArraySession {
     ...
     */
    public static SendOneofOuterArraySession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofOuterArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofOuterArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofOuterArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofOuterArraySession.
     */
    protected static class SendOneofOuterArraySessionDeserializer
        extends JsonDeserializer<SendOneofOuterArraySession> {

        @Override
        public SendOneofOuterArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
