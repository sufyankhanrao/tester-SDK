 ...
 */
@JsonDeserialize(using = SendOneofOuterMapOfArraySession.SendOneofOuterMapOfArraySessionDeserializer.class)
public abstract class SendOneofOuterMapOfArraySession {
     ...
     */
    public static SendOneofOuterMapOfArraySession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofOuterMapOfArraySession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofOuterMapOfArraySession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofOuterMapOfArraySession {
    ...
    /**
     * This is a custom deserializer class for SendOneofOuterMapOfArraySession.
     */
    protected static class SendOneofOuterMapOfArraySessionDeserializer
        extends JsonDeserializer<SendOneofOuterMapOfArraySession> {

        @Override
        public SendOneofOuterMapOfArraySession deserialize(JsonParser jp, DeserializationContext ctxt)
