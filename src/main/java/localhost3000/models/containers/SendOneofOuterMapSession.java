 ...
 */
@JsonDeserialize(using = SendOneofOuterMapSession.SendOneofOuterMapSessionDeserializer.class)
public abstract class SendOneofOuterMapSession {
     ...
     */
    public static SendOneofOuterMapSession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofOuterMapSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofOuterMapSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofOuterMapSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofOuterMapSession.
     */
    protected static class SendOneofOuterMapSessionDeserializer
        extends JsonDeserializer<SendOneofOuterMapSession> {

        @Override
        public SendOneofOuterMapSession deserialize(JsonParser jp, DeserializationContext ctxt)
