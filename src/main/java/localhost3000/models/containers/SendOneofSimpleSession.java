 ...
 */
@JsonDeserialize(using = SendOneofSimpleSession.SendOneofSimpleSessionDeserializer.class)
public abstract class SendOneofSimpleSession {
     ...
     */
    public static SendOneofSimpleSession fromMorning(Morning morning) {
     ...
     */
    public static SendOneofSimpleSession fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofSimpleSession {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofSimpleSession {
    ...
    /**
     * This is a custom deserializer class for SendOneofSimpleSession.
     */
    protected static class SendOneofSimpleSessionDeserializer
        extends JsonDeserializer<SendOneofSimpleSession> {

        @Override
        public SendOneofSimpleSession deserialize(JsonParser jp, DeserializationContext ctxt)
