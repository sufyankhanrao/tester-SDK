 ...
 */
@JsonDeserialize(using = SendOneofSimpleSession1.SendOneofSimpleSession1Deserializer.class)
public abstract class SendOneofSimpleSession1 {
     ...
     */
    public static SendOneofSimpleSession1 fromMorning(Morning morning) {
     ...
     */
    public static SendOneofSimpleSession1 fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofSimpleSession1 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofSimpleSession1 {
    ...
    /**
     * This is a custom deserializer class for SendOneofSimpleSession1.
     */
    protected static class SendOneofSimpleSession1Deserializer
        extends JsonDeserializer<SendOneofSimpleSession1> {

        @Override
        public SendOneofSimpleSession1 deserialize(JsonParser jp, DeserializationContext ctxt)
