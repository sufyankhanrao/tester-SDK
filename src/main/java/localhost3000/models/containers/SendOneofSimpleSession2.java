 ...
 */
@JsonDeserialize(using = SendOneofSimpleSession2.SendOneofSimpleSession2Deserializer.class)
public abstract class SendOneofSimpleSession2 {
     ...
     */
    public static SendOneofSimpleSession2 fromMorning(Morning morning) {
     ...
     */
    public static SendOneofSimpleSession2 fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofSimpleSession2 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofSimpleSession2 {
    ...
    /**
     * This is a custom deserializer class for SendOneofSimpleSession2.
     */
    protected static class SendOneofSimpleSession2Deserializer
        extends JsonDeserializer<SendOneofSimpleSession2> {

        @Override
        public SendOneofSimpleSession2 deserialize(JsonParser jp, DeserializationContext ctxt)
