 ...
 */
@JsonDeserialize(using = SendOneofSimpleSession3.SendOneofSimpleSession3Deserializer.class)
public abstract class SendOneofSimpleSession3 {
     ...
     */
    public static SendOneofSimpleSession3 fromMorning(Morning morning) {
     ...
     */
    public static SendOneofSimpleSession3 fromEvening(Evening evening) {
    ...
    private static class MorningCase extends SendOneofSimpleSession3 {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class EveningCase extends SendOneofSimpleSession3 {
    ...
    /**
     * This is a custom deserializer class for SendOneofSimpleSession3.
     */
    protected static class SendOneofSimpleSession3Deserializer
        extends JsonDeserializer<SendOneofSimpleSession3> {

        @Override
        public SendOneofSimpleSession3 deserialize(JsonParser jp, DeserializationContext ctxt)
