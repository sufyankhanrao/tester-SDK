 ...
 */
@JsonDeserialize(using = SimpleCaseValue.SimpleCaseValueDeserializer.class)
public abstract class SimpleCaseValue {
     ...
     */
    public static SimpleCaseValue fromPrecision(double precision) {
     ...
     */
    public static SimpleCaseValue fromMBoolean(boolean mBoolean) {
    ...
    private static class PrecisionCase extends SimpleCaseValue {
    ...
    @JsonDeserialize(using = JsonDeserializer.None.class)
    @TypeCombinatorsCaseMarker
    private static class MBooleanCase extends SimpleCaseValue {
    ...
    /**
     * This is a custom deserializer class for SimpleCaseValue.
     */
    protected static class SimpleCaseValueDeserializer
        extends JsonDeserializer<SimpleCaseValue> {

        @Override
        public SimpleCaseValue deserialize(JsonParser jp, DeserializationContext ctxt)
