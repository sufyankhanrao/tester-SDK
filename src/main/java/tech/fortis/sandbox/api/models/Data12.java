...
public class Data12 {
    ...
    public String toString() {
        return "Data12 [" + "locationId=" + locationId + ", accountType=" + accountType
                + ", active=" + active + ", cauSummaryStatusId=" + cauSummaryStatusId
                + ", createdTs=" + createdTs + ", id=" + id + ", firstSix=" + firstSix
                + ", hasRecurring=" + hasRecurring + ", lastFour=" + lastFour + ", modifiedTs="
                + modifiedTs + ", paymentMethod=" + paymentMethod + ", accountHolderName="
                ...
                + customerId + ", driversLicense=" + driversLicense + ", previousAccountVaultApiId="
                ...
                + title + ", eSerialNumber=" + eSerialNumber + ", eTrackData=" + eTrackData
                + ", eFormat=" + eFormat + ", eKeyedData=" + eKeyedData + ", expiringInMonths="
                + expiringInMonths + ", ticket=" + ticket + ", trackData=" + trackData + "]";
    }
    ...
    public static class Builder {
         ...
         */
        public Data12 build() {
            return new Data12(locationId, accountType, active, cauSummaryStatusId, createdTs, id,
