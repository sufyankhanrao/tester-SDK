...
public class Data15 {
    ...
    public String toString() {
        return "Data15 [" + "email=" + email + ", lastName=" + lastName + ", primaryLocationId="
                + primaryLocationId + ", username=" + username + ", userApiKey=" + userApiKey
                + ", userTypeId=" + userTypeId + ", accountNumber=" + accountNumber + ", address="
                + address + ", brandingDomainUrl=" + brandingDomainUrl + ", cellPhone=" + cellPhone
                + ", city=" + city + ", companyName=" + companyName + ", contactId=" + contactId
                + ", dateOfBirth=" + dateOfBirth + ", domainId=" + domainId + ", emailTrxReceipt="
                + emailTrxReceipt + ", homePhone=" + homePhone + ", firstName=" + firstName
                + ", locale=" + locale + ", officePhone=" + officePhone + ", officeExtPhone="
                + officeExtPhone + ", requiresNewPassword=" + requiresNewPassword + ", state="
                + state + ", termsConditionId=" + termsConditionId + ", tz=" + tz + ", uiPrefs="
                + uiPrefs + ", userHashKey=" + userHashKey + ", password=" + password + ", zip="
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(email, lastName, primaryLocationId, username, userApiKey,
                userTypeId)
    ...
    public static class Builder {
        ...
        public Builder(String email, String lastName, String primaryLocationId, String username,
                String userApiKey, UserTypeIdEnum userTypeId) {
            this.email = email;
            this.lastName = lastName;
            this.primaryLocationId = primaryLocationId;
            this.username = username;
         ...
         */
        public Data15 build() {
            return new Data15(email, lastName, primaryLocationId, username, userApiKey, userTypeId,
                    accountNumber, address, brandingDomainUrl, cellPhone, city, companyName,
                    contactId, dateOfBirth, domainId, emailTrxReceipt, homePhone, firstName, locale,
                    officePhone, officeExtPhone, requiresNewPassword, state, termsConditionId, tz,
                    uiPrefs, userHashKey, password, zip, locationId, contactApiId,
                    primaryLocationApiId, statusId);
        }
    }
}
