...
public class Data2 {
     ...
     * @param  headerMessageType  int value for headerMessageType.
     ...
     * Header Message Type
     * @param headerMessageType Value for int
     */
    ...
    public String toString() {
        return "Data2 [" + "locationId=" + locationId + ", lastName=" + lastName
                + ", emailTrxReceipt=" + emailTrxReceipt + ", headerMessageType="
                + headerMessageType + ", id=" + id + ", createdTs=" + createdTs + ", modifiedTs="
                + modifiedTs + ", active=" + active + ", accountNumber=" + accountNumber
                + ", contactApiId=" + contactApiId + ", firstName=" + firstName + ", cellPhone="
                + cellPhone + ", contactBalance=" + contactBalance + ", address=" + address
                + ", city=" + city + ", state=" + state + ", companyName=" + companyName
                + ", headerMessage=" + headerMessage + ", dateOfBirth=" + dateOfBirth
                + ", homePhone=" + homePhone + ", officePhone=" + officePhone + ", officeExtPhone="
                + officeExtPhone + ", updateIfExists=" + updateIfExists + ", zip=" + zip
                + ", contactC1=" + contactC1 + ", contactC2=" + contactC2 + ", contactC3="
                + contactC3 + ", parentId=" + parentId + ", email=" + email + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(locationId, lastName, emailTrxReceipt, headerMessageType, id,
                createdTs, modifiedTs, active)
    ...
    public static class Builder {
         ...
         * @param  active  int value for active.
         */
        public Builder(String locationId, String lastName, boolean emailTrxReceipt,
                int headerMessageType, String id, LocalDateTime createdTs, LocalDateTime modifiedTs,
                int active) {
            this.locationId = locationId;
            this.lastName = lastName;
            this.emailTrxReceipt = emailTrxReceipt;
         ...
         * @return Builder
         */
        public Builder headerMessageType(int headerMessageType) {
            this.headerMessageType = headerMessageType;
            return this;
        }
         ...
         */
        public Data2 build() {
            return new Data2(locationId, lastName, emailTrxReceipt, headerMessageType, id,
                    createdTs, modifiedTs, active, accountNumber, contactApiId, firstName,
                    cellPhone, contactBalance, address, city, state, companyName, headerMessage,
                    dateOfBirth, homePhone, officePhone, officeExtPhone, updateIfExists, zip,
                    contactC1, contactC2, contactC3, parentId, email);
        }
    }
}
