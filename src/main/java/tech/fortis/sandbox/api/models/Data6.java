...
public class Data6 {
     ...
     * @param  epicAppId  String value for epicAppId.
     ...
     * retrieve and resume the generated merchant application. No link will be returned for the
     * Default.
     * @return Returns the String
     */
    @JsonGetter("app_link")
    ...
    /**
     * Getter for EpicAppId.
     * Fortis internal ID. Can be created that can be used to uniquely reference an application if a
     * client_app_id is not supplied.
     * @return Returns the String
     */
    @JsonGetter("epic_app_id")
    public String getEpicAppId() {
        return epicAppId;
    }

    /**
     * Setter for EpicAppId.
     * Fortis internal ID. Can be created that can be used to uniquely reference an application if a
     * client_app_id is not supplied.
     * @param epicAppId Value for String
     */
    @JsonSetter("epic_app_id")
    public void setEpicAppId(String epicAppId) {
        this.epicAppId = epicAppId;
    }
    ...
    public String toString() {
        return "Data6 [" + "primaryPrincipal=" + primaryPrincipal + ", templateCode=" + templateCode
                + ", email=" + email + ", dbaName=" + dbaName + ", location=" + location
                + ", appDelivery=" + appDelivery + ", bankAccount=" + bankAccount + ", contact="
                + contact + ", clientAppId=" + clientAppId + ", id=" + id + ", appLink=" + appLink
                + ", epicAppId=" + epicAppId + ", businessCategory=" + businessCategory
                ...
                + ", appCompleteEndpoint=" + appCompleteEndpoint + ", isTest=" + isTest + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(primaryPrincipal, templateCode, email, dbaName, location,
                appDelivery, bankAccount, contact, clientAppId, id, appLink, epicAppId)
    ...
    public static class Builder {
        ...
        public Builder(PrimaryPrincipal primaryPrincipal, String templateCode, String email,
                String dbaName, Location location, String appDelivery, BankAccount bankAccount,
                Contact contact, String clientAppId, String id, String appLink, String epicAppId) {
            this.primaryPrincipal = primaryPrincipal;
            this.templateCode = templateCode;
            this.email = email;
            this.dbaName = dbaName;
         ...
         * @return Builder
         */
        public Builder epicAppId(String epicAppId) {
            this.epicAppId = epicAppId;
            return this;
        }
         ...
         */
        public Data6 build() {
            return new Data6(primaryPrincipal, templateCode, email, dbaName, location, appDelivery,
                    bankAccount, contact, clientAppId, id, appLink, epicAppId, businessCategory,
                    businessType, businessDescription, swipedPercent, keyedPercent,
                    ecommercePercent, ownershipType, fedTaxId, ccAverageTicketRange,
                    ccMonthlyVolumeRange, ccHighTicket, ecAverageTicketRange, ecMonthlyVolumeRange,
                    ecHighTicket, website, legalName, appCompleteEndpoint, isTest);
        }
    }
}
