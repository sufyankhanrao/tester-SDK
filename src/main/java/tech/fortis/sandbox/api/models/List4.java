...
public class List4 {
     ...
     */
    protected List4(String locationId, String title, String ccProductTransactionId, String dueDate,
            List<ItemList> itemList, String id, LocalDateTime createdTs, LocalDateTime modifiedTs,
            String achProductTransactionId, Boolean allowOverpayment,
            OptionalNullable<String> email, String contactId, String contactApiId,
            String customerId, String expireDate, Boolean allowPartialPay,
            ...
            OptionalNullable<String> cellPhone, String createdUserId, String modifiedUserId,
    ...
    public String toString() {
        return "List4 [" + "locationId=" + locationId + ", title=" + title
                + ", ccProductTransactionId=" + ccProductTransactionId + ", dueDate=" + dueDate
                + ", itemList=" + itemList + ", id=" + id + ", createdTs=" + createdTs
                + ", modifiedTs=" + modifiedTs + ", achProductTransactionId="
                + achProductTransactionId + ", allowOverpayment=" + allowOverpayment + ", email="
    ...
    public static class Builder {
        ...
        public Builder(String locationId, String title, String ccProductTransactionId,
                String dueDate, List<ItemList> itemList, String id, LocalDateTime createdTs,
                LocalDateTime modifiedTs) {
            this.locationId = locationId;
            this.title = title;
            this.ccProductTransactionId = ccProductTransactionId;
         ...
         */
        public List4 build() {
            return new List4(locationId, title, ccProductTransactionId, dueDate, itemList, id,
                    createdTs, modifiedTs, achProductTransactionId, allowOverpayment, email,
                    contactId, contactApiId, customerId, expireDate, allowPartialPay,
                    attachFilesToEmail, sendEmail, invoiceNumber, itemHeader, itemFooter, amountDue,
                    notificationEmail, paymentStatusId, statusId, note,
                    notificationDaysBeforeDueDate, notificationDaysAfterDueDate,
                    notificationOnDueDate, sendTextToPay, files, remainingBalance,
                    singlePaymentMinAmount, singlePaymentMaxAmount, cellPhone, createdUserId,
                    modifiedUserId, active, isActive);
        }
    }
}
