...
public enum OnDeleteEnum {
    ...
    private static TreeMap<Integer, OnDeleteEnum> valueMap = new TreeMap<>();
    ...
    public static OnDeleteEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of OnDeleteEnum values to list of integer values.
     * @param toConvert The list of OnDeleteEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<OnDeleteEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (OnDeleteEnum enumValue : toConvert) {
