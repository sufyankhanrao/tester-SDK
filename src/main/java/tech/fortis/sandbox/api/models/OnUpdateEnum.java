...
public enum OnUpdateEnum {
    ...
    private static TreeMap<Integer, OnUpdateEnum> valueMap = new TreeMap<>();
    ...
    public static OnUpdateEnum fromInteger(Integer toConvert) {
    ...
    /**
     * Convert list of OnUpdateEnum values to list of integer values.
     * @param toConvert The list of OnUpdateEnum values to convert.
     * @return List of representative integer values.
     */
    public static List<Integer> toValue(List<OnUpdateEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<Integer> convertedValues = new ArrayList<>();
        for (OnUpdateEnum enumValue : toConvert) {
