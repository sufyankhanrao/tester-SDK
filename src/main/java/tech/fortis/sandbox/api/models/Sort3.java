...
/**
 * This is a model class for Sort3 type.
 */
public class Sort3 {
    ...
    private BrandingDomainEnum brandingDomain;
    private ProductTransactionsEnum productTransactions;
    private ProductFileEnum productFile;
    private ProductAccountvaultEnum productAccountvault;
    private ProductRecurringEnum productRecurring;
    private TagsEnum tags;
    private TerminalsEnum terminals;
     ...
     * @param  brandingDomain  BrandingDomainEnum value for brandingDomain.
     * @param  productTransactions  ProductTransactionsEnum value for productTransactions.
     * @param  productFile  ProductFileEnum value for productFile.
     * @param  productAccountvault  ProductAccountvaultEnum value for productAccountvault.
     * @param  productRecurring  ProductRecurringEnum value for productRecurring.
     * @param  tags  TagsEnum value for tags.
     * @param  terminals  TerminalsEnum value for terminals.
     */
    public Sort3(
            ...
            ProductTransactionsEnum productTransactions,
            ProductFileEnum productFile,
            ProductAccountvaultEnum productAccountvault,
            ProductRecurringEnum productRecurring,
            TagsEnum tags,
            TerminalsEnum terminals) {
     ...
     * @return Returns the BrandingDomainEnum
     */
    @JsonGetter("branding_domain")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public BrandingDomainEnum getBrandingDomain() {
        return brandingDomain;
    }

    /**
     * Setter for BrandingDomain.
     * @param brandingDomain Value for BrandingDomainEnum
     */
    @JsonSetter("branding_domain")
    public void setBrandingDomain(BrandingDomainEnum brandingDomain) {
        this.brandingDomain = brandingDomain;
    }

    /**
     * Getter for ProductTransactions.
     * @return Returns the ProductTransactionsEnum
     */
    @JsonGetter("product_transactions")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ProductTransactionsEnum getProductTransactions() {
        return productTransactions;
    }

    /**
     * Setter for ProductTransactions.
     * @param productTransactions Value for ProductTransactionsEnum
     */
    @JsonSetter("product_transactions")
    public void setProductTransactions(ProductTransactionsEnum productTransactions) {
        this.productTransactions = productTransactions;
    }

    /**
     * Getter for ProductFile.
     * @return Returns the ProductFileEnum
     */
    @JsonGetter("product_file")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ProductFileEnum getProductFile() {
        return productFile;
    }

    /**
     * Setter for ProductFile.
     * @param productFile Value for ProductFileEnum
     */
    @JsonSetter("product_file")
    public void setProductFile(ProductFileEnum productFile) {
        this.productFile = productFile;
    }

    /**
     * Getter for ProductAccountvault.
     * @return Returns the ProductAccountvaultEnum
     */
    @JsonGetter("product_accountvault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ProductAccountvaultEnum getProductAccountvault() {
        return productAccountvault;
    }

    /**
     * Setter for ProductAccountvault.
     * @param productAccountvault Value for ProductAccountvaultEnum
     */
    @JsonSetter("product_accountvault")
    public void setProductAccountvault(ProductAccountvaultEnum productAccountvault) {
        this.productAccountvault = productAccountvault;
    }

    /**
     * Getter for ProductRecurring.
     * @return Returns the ProductRecurringEnum
     */
    @JsonGetter("product_recurring")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ProductRecurringEnum getProductRecurring() {
        return productRecurring;
    }

    /**
     * Setter for ProductRecurring.
     * @param productRecurring Value for ProductRecurringEnum
     */
    @JsonSetter("product_recurring")
    public void setProductRecurring(ProductRecurringEnum productRecurring) {
        this.productRecurring = productRecurring;
    }
     ...
     * @return Returns the TerminalsEnum
     */
    @JsonGetter("terminals")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public TerminalsEnum getTerminals() {
        return terminals;
    }

    /**
     * Setter for Terminals.
     * @param terminals Value for TerminalsEnum
     */
    @JsonSetter("terminals")
    public void setTerminals(TerminalsEnum terminals) {
        this.terminals = terminals;
    }

    /**
     * Converts this Sort3 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Sort3 [" + "brandingDomainUrl=" + brandingDomainUrl + ", createdTs=" + createdTs
    ...
    /**
     * Builds a new {@link Sort3.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Sort3.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Sort3}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder brandingDomain(BrandingDomainEnum brandingDomain) {
            this.brandingDomain = brandingDomain;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder productTransactions(ProductTransactionsEnum productTransactions) {
            this.productTransactions = productTransactions;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder productFile(ProductFileEnum productFile) {
            this.productFile = productFile;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder productAccountvault(ProductAccountvaultEnum productAccountvault) {
            this.productAccountvault = productAccountvault;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder productRecurring(ProductRecurringEnum productRecurring) {
            this.productRecurring = productRecurring;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder terminals(TerminalsEnum terminals) {
            this.terminals = terminals;
            return this;
        }

        /**
         * Builds a new {@link Sort3} object using the set fields.
         * @return {@link Sort3}
         */
        public Sort3 build() {
            return new Sort3(brandingDomainUrl, createdTs, id, modifiedTs, aba, accountNumber,
