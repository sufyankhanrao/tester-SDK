...
/**
 * This is a model class for V1ContactsRequest type.
 */
public class V1ContactsRequest {
    ...
    /**
     * Converts this V1ContactsRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1ContactsRequest [" + "locationId=" + locationId + ", lastName=" + lastName
                + ", accountNumber=" + accountNumber + ", contactApiId=" + contactApiId
                + ", firstName=" + firstName + ", cellPhone=" + cellPhone + ", contactBalance="
    ...
    /**
     * Builds a new {@link V1ContactsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1ContactsRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(locationId, lastName)
    ...
    /**
     * Class to build instances of {@link V1ContactsRequest}.
     */
    public static class Builder {
         ...
         * @param  lastName  String value for lastName.
         */
        public Builder(String locationId, String lastName) {
            this.locationId = locationId;
            this.lastName = lastName;
        }
        ...
        /**
         * Builds a new {@link V1ContactsRequest} object using the set fields.
         * @return {@link V1ContactsRequest}
         */
        public V1ContactsRequest build() {
            return new V1ContactsRequest(locationId, lastName, accountNumber, contactApiId,
                    firstName, cellPhone, contactBalance, address, city, state, companyName,
