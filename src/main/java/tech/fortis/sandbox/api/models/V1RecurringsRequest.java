...
public class V1RecurringsRequest {
    ...
    public String toString() {
        return "V1RecurringsRequest [" + "accountVaultId=" + accountVaultId + ", interval="
                + interval + ", intervalType=" + intervalType + ", locationId=" + locationId
                + ", startDate=" + startDate + ", transactionAmount=" + transactionAmount
                + ", active=" + active + ", description=" + description + ", endDate=" + endDate
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(accountVaultId, interval, intervalType, locationId, startDate,
                transactionAmount)
                .active(getActive())
    ...
    public static class Builder {
         ...
         * @param  transactionAmount  double value for transactionAmount.
         */
        public Builder(String accountVaultId, int interval, IntervalTypeEnum intervalType,
                String locationId, String startDate, double transactionAmount) {
            this.accountVaultId = accountVaultId;
            this.interval = interval;
            this.intervalType = intervalType;
            this.locationId = locationId;
        ...
        public V1RecurringsRequest build() {
            return new V1RecurringsRequest(accountVaultId, interval, intervalType, locationId,
                    startDate, transactionAmount, active, description, endDate,
                    installmentTotalCount, notificationDays, paymentMethod, productTransactionId,
                    recurringId, recurringApiId, status, termsAgree, termsAgreeIp, recurringC1,
                    recurringC2, recurringC3, sendToProcAsRecur);
        }
    }
}
