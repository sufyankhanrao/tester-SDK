...
/**
 * This is a model class for V1TokensAchRequest type.
 */
public class V1TokensAchRequest {
    ...
    /**
     * Converts this V1TokensAchRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TokensAchRequest [" + "accountHolderName=" + accountHolderName
                + ", accountNumber=" + accountNumber + ", locationId=" + locationId
                + ", accountType=" + accountType + ", isCompany=" + isCompany + ", routing="
                + routing + ", accountVaultApiId=" + accountVaultApiId + ", accountvaultC1="
                ...
                + ", termsAgreeIp=" + termsAgreeIp + ", title=" + title + ", dobYear=" + dobYear
                + "]";
    }

    /**
     * Builds a new {@link V1TokensAchRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TokensAchRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(accountHolderName, accountNumber, locationId, accountType,
                isCompany, routing)
    ...
    /**
     * Class to build instances of {@link V1TokensAchRequest}.
     */
    public static class Builder {
         ...
         * @param  routing  String value for routing.
         */
        public Builder(String accountHolderName, String accountNumber, String locationId,
                AccountType2Enum accountType, boolean isCompany, String routing) {
            this.accountHolderName = accountHolderName;
            this.accountNumber = accountNumber;
            this.locationId = locationId;
            this.accountType = accountType;
        ...
        /**
         * Builds a new {@link V1TokensAchRequest} object using the set fields.
         * @return {@link V1TokensAchRequest}
         */
        public V1TokensAchRequest build() {
            return new V1TokensAchRequest(accountHolderName, accountNumber, locationId, accountType,
                    isCompany, routing, accountVaultApiId, accountvaultC1, accountvaultC2,
                    ...
                    termsAgree, termsAgreeIp, title, dobYear);
        }
    }
}
