...
/**
 * This is a model class for V1TokensCcRequest type.
 */
public class V1TokensCcRequest {
    ...
    /**
     * Converts this V1TokensCcRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TokensCcRequest [" + "accountNumber=" + accountNumber + ", locationId="
                + locationId + ", expDate=" + expDate + ", accountHolderName=" + accountHolderName
                + ", accountVaultApiId=" + accountVaultApiId + ", accountvaultC1=" + accountvaultC1
                + ", accountvaultC2=" + accountvaultC2 + ", accountvaultC3=" + accountvaultC3
                + ", achSecCode=" + achSecCode + ", billingAddress=" + billingAddress
                ...
                + ", eKeyedData=" + eKeyedData + ", runAvs=" + runAvs + ", trackData=" + trackData
                + ", ticket=" + ticket + "]";
    }

    /**
     * Builds a new {@link V1TokensCcRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TokensCcRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(accountNumber, locationId, expDate)
    ...
    /**
     * Class to build instances of {@link V1TokensCcRequest}.
     */
    public static class Builder {
         ...
         * @param  expDate  String value for expDate.
         */
        public Builder(String accountNumber, String locationId, String expDate) {
            this.accountNumber = accountNumber;
            this.locationId = locationId;
            this.expDate = expDate;
        }
        ...
        /**
         * Builds a new {@link V1TokensCcRequest} object using the set fields.
         * @return {@link V1TokensCcRequest}
         */
        public V1TokensCcRequest build() {
            return new V1TokensCcRequest(accountNumber, locationId, expDate, accountHolderName,
                    accountVaultApiId, accountvaultC1, accountvaultC2, accountvaultC3, achSecCode,
                    billingAddress, billingCity, billingPhone, billingState, billingZip, contactId,
                    customerId, driversLicense, previousAccountVaultApiId, previousAccountVaultId,
                    previousTransactionId, ssn4, termsAgree, termsAgreeIp, title, eSerialNumber,
                    eTrackData, eFormat, eKeyedData, runAvs, trackData, ticket);
        }
    }
}
