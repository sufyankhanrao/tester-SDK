...
public class V1TokensPreviousTransactionRequest {
    ...
    public String toString() {
        return "V1TokensPreviousTransactionRequest [" + "locationId=" + locationId
                ...
                + ", ssn4=" + ssn4 + ", termsAgree=" + termsAgree + ", termsAgreeIp=" + termsAgreeIp
                + ", title=" + title + "]";
    }
    ...
    public static class Builder {
        ...
        public V1TokensPreviousTransactionRequest build() {
            return new V1TokensPreviousTransactionRequest(locationId, previousTransactionId,
                    ...
                    previousAccountVaultApiId, previousAccountVaultId, ssn4, termsAgree,
                    termsAgreeIp, title);
        }
    }
}
