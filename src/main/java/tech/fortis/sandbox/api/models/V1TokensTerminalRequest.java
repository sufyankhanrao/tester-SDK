...
/**
 * This is a model class for V1TokensTerminalRequest type.
 */
public class V1TokensTerminalRequest {
    ...
    /**
     * Converts this V1TokensTerminalRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TokensTerminalRequest [" + "contactId=" + contactId + ", locationId=" + locationId
                + ", action=" + action + ", terminalId=" + terminalId + ", accountHolderName="
                + accountHolderName + ", accountNumber=" + accountNumber + ", accountVaultApiId="
                + accountVaultApiId + ", accountvaultC1=" + accountvaultC1 + ", accountvaultC2="
                + accountvaultC2 + ", accountvaultC3=" + accountvaultC3 + ", achSecCode="
                + achSecCode + ", billingAddress=" + billingAddress + ", billingCity=" + billingCity
                + ", billingPhone=" + billingPhone + ", billingState=" + billingState
                + ", billingZip=" + billingZip + ", customerId=" + customerId + ", driversLicense="
                + driversLicense + ", previousAccountVaultApiId=" + previousAccountVaultApiId
                + ", previousAccountVaultId=" + previousAccountVaultId + ", previousTransactionId="
                + previousTransactionId + ", ssn4=" + ssn4 + ", termsAgree=" + termsAgree
                + ", termsAgreeIp=" + termsAgreeIp + ", title=" + title + "]";
    }

    /**
     * Builds a new {@link V1TokensTerminalRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TokensTerminalRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(contactId, locationId, action, terminalId)
    ...
    /**
     * Class to build instances of {@link V1TokensTerminalRequest}.
     */
    public static class Builder {
        private String contactId;
        private String locationId;
        private String action = "store";
        private String terminalId;
        private String accountHolderName;
        private String accountNumber;
        private String accountVaultApiId;
         ...
         * @param  terminalId  String value for terminalId.
         */
        public Builder(String contactId, String locationId, String action, String terminalId) {
            this.contactId = contactId;
            this.locationId = locationId;
            this.action = action;
            this.terminalId = terminalId;
        ...
        /**
         * Builds a new {@link V1TokensTerminalRequest} object using the set fields.
         * @return {@link V1TokensTerminalRequest}
         */
        public V1TokensTerminalRequest build() {
            return new V1TokensTerminalRequest(contactId, locationId, action, terminalId,
                    accountHolderName, accountNumber, accountVaultApiId, accountvaultC1,
                    accountvaultC2, accountvaultC3, achSecCode, billingAddress, billingCity,
                    billingPhone, billingState, billingZip, customerId, driversLicense,
                    previousAccountVaultApiId, previousAccountVaultId, previousTransactionId, ssn4,
                    termsAgree, termsAgreeIp, title);
        }
    }
}
