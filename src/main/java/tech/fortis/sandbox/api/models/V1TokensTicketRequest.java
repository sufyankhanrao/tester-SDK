...
/**
 * This is a model class for V1TokensTicketRequest type.
 */
public class V1TokensTicketRequest {
    ...
    /**
     * Converts this V1TokensTicketRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TokensTicketRequest [" + "locationId=" + locationId + ", ticket=" + ticket
    ...
    /**
     * Builds a new {@link V1TokensTicketRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TokensTicketRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(locationId, ticket)
    ...
    /**
     * Class to build instances of {@link V1TokensTicketRequest}.
     */
    public static class Builder {
         ...
         * @param  ticket  String value for ticket.
         */
        public Builder(String locationId, String ticket) {
            this.locationId = locationId;
            this.ticket = ticket;
        }
        ...
        /**
         * Builds a new {@link V1TokensTicketRequest} object using the set fields.
         * @return {@link V1TokensTicketRequest}
         */
        public V1TokensTicketRequest build() {
            return new V1TokensTicketRequest(locationId, ticket, accountHolderName, accountNumber,
                    ...
                    previousTransactionId, ssn4, termsAgree, termsAgreeIp, title);
        }
    }
}
