...
/**
 * This is a model class for V1TransactionsAchDebitKeyedRequest type.
 */
public class V1TransactionsAchDebitKeyedRequest {
    ...
    private AccountType6Enum accountType;
     ...
     * @param  accountType  AccountType6Enum value for accountType.
     ...
     * Required for ACH transactions if account_vault_id is not provided.
     * @return Returns the AccountType6Enum
     */
    @JsonGetter("account_type")
    public AccountType6Enum getAccountType() {
        return accountType;
    }
     ...
     * Required for ACH transactions if account_vault_id is not provided.
     * @param accountType Value for AccountType6Enum
     */
    @JsonSetter("account_type")
    public void setAccountType(AccountType6Enum accountType) {
        this.accountType = accountType;
    }
    ...
    /**
     * Converts this V1TransactionsAchDebitKeyedRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TransactionsAchDebitKeyedRequest [" + "transactionAmount=" + transactionAmount
                + ", achSecCode=" + achSecCode + ", accountHolderName=" + accountHolderName
                + ", accountNumber=" + accountNumber + ", accountType=" + accountType + ", routing="
                + routing + ", additionalAmounts=" + additionalAmounts + ", billingCity="
                ...
                + achIdentifier + ", effectiveDate=" + effectiveDate + ", ssn4=" + ssn4
                + ", checkNumber=" + checkNumber + "]";
    }

    /**
     * Builds a new {@link V1TransactionsAchDebitKeyedRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TransactionsAchDebitKeyedRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(transactionAmount, achSecCode, accountHolderName,
                accountNumber, accountType, routing)
    ...
    /**
     * Class to build instances of {@link V1TransactionsAchDebitKeyedRequest}.
     */
    public static class Builder {
         ...
         * @param  routing  String value for routing.
         */
        public Builder(double transactionAmount, String achSecCode, String accountHolderName,
                String accountNumber, AccountType6Enum accountType, String routing) {
            this.transactionAmount = transactionAmount;
            this.achSecCode = achSecCode;
            this.accountHolderName = accountHolderName;
            this.accountNumber = accountNumber;
         ...
         * @return Builder
         */
        public Builder accountType(AccountType6Enum accountType) {
            this.accountType = accountType;
            return this;
        }
        ...
        /**
         * Builds a new {@link V1TransactionsAchDebitKeyedRequest} object using the set fields.
         * @return {@link V1TransactionsAchDebitKeyedRequest}
         */
        public V1TransactionsAchDebitKeyedRequest build() {
            return new V1TransactionsAchDebitKeyedRequest(transactionAmount, achSecCode,
                    accountHolderName, accountNumber, accountType, routing, additionalAmounts,
                    billingCity, billingPhone, billingState, billingStreet, billingZip, checkinDate,
                    checkoutDate, clerkNumber, contactApiId, contactId, customData, customerId,
                    customerIp, description, dlNumber, dlState, dobYear, iiasInd, imageFront,
                    imageBack, installment, installmentNumber, installmentCount, locationApiId,
                    locationId, noShow, notificationEmailAddress, orderNum, poNumber,
                    previousTransactionId, productTransactionId, quickInvoiceId, recurring,
                    recurringNumber, roomNum, roomRate, saveAccount, saveAccountTitle, settleDate,
                    statusId, subtotalAmount, surchargeAmount, tags, safe, tax, terminalId,
                    termsAgree, termsAgreeIp, ticket, tipAmount, transactionApiId, transactionC1,
                    transactionC2, transactionC3, transactionC4, trxSourceId, achIdentifier,
                    effectiveDate, ssn4, checkNumber);
        }
    }
}
