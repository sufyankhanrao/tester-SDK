...
/**
 * This is a model class for V1TransactionsTipAdjustRequest type.
 */
public class V1TransactionsTipAdjustRequest {
    private List<AdditionalAmounts1> additionalAmounts;
     ...
     * @param  additionalAmounts  List of AdditionalAmounts1 value for additionalAmounts.
    ...
    public V1TransactionsTipAdjustRequest(
            ...
            List<AdditionalAmounts1> additionalAmounts,
            String billingCity,
            String billingPhone,
            String billingState,
     ...
     * Additional amounts
     * @return Returns the List of AdditionalAmounts1
     */
    @JsonGetter("additional_amounts")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<AdditionalAmounts1> getAdditionalAmounts() {
     ...
     * Additional amounts
     * @param additionalAmounts Value for List of AdditionalAmounts1
     */
    @JsonSetter("additional_amounts")
    public void setAdditionalAmounts(List<AdditionalAmounts1> additionalAmounts) {
        this.additionalAmounts = additionalAmounts;
    }
    ...
    /**
     * Converts this V1TransactionsTipAdjustRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "V1TransactionsTipAdjustRequest [" + "tipAmount=" + tipAmount
                + ", transactionAmount=" + transactionAmount + ", additionalAmounts="
                + additionalAmounts + ", billingCity=" + billingCity + ", billingPhone="
                + billingPhone + ", billingState=" + billingState + ", billingStreet="
                + billingStreet + ", billingZip=" + billingZip + ", checkinDate=" + checkinDate
                + ", checkoutDate=" + checkoutDate + ", clerkNumber=" + clerkNumber
                + ", contactApiId=" + contactApiId + ", contactId=" + contactId + ", customData="
                + customData + ", customerId=" + customerId + ", customerIp=" + customerIp
                + ", description=" + description + ", dlNumber=" + dlNumber + ", dlState=" + dlState
                + ", dobYear=" + dobYear + ", iiasInd=" + iiasInd + ", imageFront=" + imageFront
                + ", imageBack=" + imageBack + ", installment=" + installment
                + ", installmentNumber=" + installmentNumber + ", installmentCount="
                + installmentCount + ", locationApiId=" + locationApiId + ", locationId="
                + locationId + ", noShow=" + noShow + ", notificationEmailAddress="
                + notificationEmailAddress + ", orderNum=" + orderNum + ", poNumber=" + poNumber
                + ", previousTransactionId=" + previousTransactionId + ", productTransactionId="
                + productTransactionId + ", quickInvoiceId=" + quickInvoiceId + ", recurring="
                + recurring + ", recurringNumber=" + recurringNumber + ", roomNum=" + roomNum
                + ", roomRate=" + roomRate + ", saveAccount=" + saveAccount + ", saveAccountTitle="
                ...
                + ", ticket=" + ticket + ", transactionApiId=" + transactionApiId
                + ", transactionC1=" + transactionC1 + ", transactionC2=" + transactionC2
                + ", transactionC3=" + transactionC3 + ", transactionC4=" + transactionC4
                + ", trxSourceId=" + trxSourceId + ", advanceDeposit=" + advanceDeposit
                + ", authAmount=" + authAmount + ", cardholderPresent=" + cardholderPresent
                ...
                + threedsecure + ", walletId=" + walletId + "]";
    }

    /**
     * Builds a new {@link V1TransactionsTipAdjustRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link V1TransactionsTipAdjustRequest.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(tipAmount, transactionAmount)
    ...
    /**
     * Class to build instances of {@link V1TransactionsTipAdjustRequest}.
     */
    public static class Builder {
         ...
         * @param  transactionAmount  double value for transactionAmount.
         */
        public Builder(double tipAmount, double transactionAmount) {
            this.tipAmount = tipAmount;
            this.transactionAmount = transactionAmount;
        }
         ...
         * @return Builder
         */
        public Builder additionalAmounts(List<AdditionalAmounts1> additionalAmounts) {
            this.additionalAmounts = additionalAmounts;
            return this;
        }
        ...
        /**
         * Builds a new {@link V1TransactionsTipAdjustRequest} object using the set fields.
         * @return {@link V1TransactionsTipAdjustRequest}
         */
        public V1TransactionsTipAdjustRequest build() {
            return new V1TransactionsTipAdjustRequest(tipAmount, transactionAmount,
                    ...
                    terminalId, termsAgree, termsAgreeIp, ticket, transactionApiId, transactionC1,
                    transactionC2, transactionC3, transactionC4, trxSourceId, advanceDeposit,
                    authAmount, cardholderPresent, cardPresent, secureAuthData,
