...
public class V1UsersRequest {
    ...
    public String toString() {
        return "V1UsersRequest [" + "email=" + email + ", lastName=" + lastName
                ...
                + uiPrefs + ", userApiKey=" + userApiKey + ", userHashKey=" + userHashKey
                + ", password=" + password + ", zip=" + zip + ", locationId=" + locationId
                + ", contactApiId=" + contactApiId + ", primaryLocationApiId="
                + primaryLocationApiId + ", statusId=" + statusId + "]";
    }
    ...
    public Builder toBuilder() {
        Builder builder = new Builder(email, lastName, primaryLocationId, username, userTypeId)
    ...
    public static class Builder {
        ...
        public V1UsersRequest build() {
            return new V1UsersRequest(email, lastName, primaryLocationId, username, userTypeId,
