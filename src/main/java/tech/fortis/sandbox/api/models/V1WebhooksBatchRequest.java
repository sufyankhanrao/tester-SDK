...
public class V1WebhooksBatchRequest {
     ...
     */
    protected V1WebhooksBatchRequest(boolean isActive, String locationId, OnCreateEnum onCreate,
            OnUpdateEnum onUpdate, OnDeleteEnum onDelete, String productTransactionId,
            int numberOfAttempts, String url, Integer attemptInterval,
    ...
    public String toString() {
        return "V1WebhooksBatchRequest [" + "isActive=" + isActive + ", locationId=" + locationId
                ...
                + ", locationApiId=" + locationApiId + ", postbackConfigId=" + postbackConfigId
                + ", resource=" + resource + "]";
    }
    ...
    public static class Builder {
        ...
        public V1WebhooksBatchRequest build() {
            return new V1WebhooksBatchRequest(isActive, locationId, onCreate, onUpdate, onDelete,
                    ...
                    basicAuthPassword, expands, format, locationApiId, postbackConfigId, resource);
        }
    }
}
