...
public class BaseControllerTest {
     ...
     */
    protected static AnyOfNonScalarEndpointsClient createConfigurationFromEnvironment() {
        AnyOfNonScalarEndpointsClient.Builder builder = new AnyOfNonScalarEndpointsClient.Builder();

        final String environment = System.getenv("ANY_OF_NON_SCALAR_ENDPOINTS_LIB_ENVIRONMENT");
        final String version = System.getenv("ANY_OF_NON_SCALAR_ENDPOINTS_LIB_VERSION");
        final String timeout = System.getenv("ANY_OF_NON_SCALAR_ENDPOINTS_LIB_TIMEOUT");
     ...
     */
    protected static AnyOfNonScalarEndpointsClient createConfiguration() {
        // Set Configuration parameters for test execution
        AnyOfNonScalarEndpointsClient config = createConfigurationFromEnvironment();
