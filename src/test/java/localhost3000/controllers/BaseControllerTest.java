...
public class BaseControllerTest {
     ...
     */
    protected static NullableClient createConfigurationFromEnvironment() {
        NullableClient.Builder builder = new NullableClient.Builder();

        final String environment = System.getenv("NULLABLE_LIB_ENVIRONMENT");
        final String timeout = System.getenv("NULLABLE_LIB_TIMEOUT");
     ...
     */
    protected static NullableClient createConfiguration() {
        // Set Configuration parameters for test execution
        NullableClient config = createConfigurationFromEnvironment();
